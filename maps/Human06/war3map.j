...
//===========================================================================
function Trig_Get_Ahead_Locations_Func001Func003C takes nothing returns boolean
...
function Trig_Get_Ahead_Locations_Actions takes nothing returns nothing
    if ( Trig_Get_Ahead_Locations_Func001C() ) then
        ...
        if ( Trig_Get_Ahead_Locations_Func001Func003C() ) then
            call status_check_location(23)
        else
            call DoNothing()
        endif
