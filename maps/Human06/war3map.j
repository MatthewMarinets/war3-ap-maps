...
globals
    ...
    integer             udg_RegionLength
    rect                udg_RegionPicked           = null
    integer             udg_RegionBucket
    integer array       udg_TargetArray
    integer             udg_TargetArrayLength
    unit                udg_MalganisTargetHouse    = null
    group array         udg_BuildingsToAttackArray
    real                udg_DeathsOfDeathSquad
    real                udg_MalganisConversions
    real                udg_ArthasDenials
    ...
    integer             udg_RANDOMINTEGER
    timerdialog         udg_MalganisCountdown      = null
    quest               udg_CullingQuest           = null
    timer               udg_MalganisTimer          = null
    boolean             udg_VictoryCinSkip
    boolean             udg_WaygateCin1Playing
    boolean             udg_MalganisFirstTeleCin
    boolean             udg_MalganisGloatCin
    boolean             udg_WaygateCin2Playing
    boolean             udg_WaygateCin3Playing
    boolean             udg_MalganisFirstTeleCinSkip
    real                udg_MalganisTargetHouseX
    real                udg_MalganisTargetHouseY
    real                udg_MalganisCaptainX
    real                udg_MalganisCaptainY
    timer               udg_MalganisAttackTimer    = null
    boolean             udg_BootingPlayer
    group               udg_VillagerToZombieGROUP  = null
    unit                udg_VillagerToBeConverted  = null
    fogmodifier         udg_WaterfallRevealVis     = null
    boolean             udg_WaterfallSwitch
    effect              udg_TeleportEffect         = null
    boolean             udg_Teleporting
    integer             udg_NextSquad
    boolean             udg_EndCinematicPlaying
    boolean             udg_BuildingsGone
    group               udg_SelectedUnits          = null
    unit                udg_RevivalAltar           = null
    location            udg_ArthasReturnPoint      = null
    group               udg_HideUnits              = null
    boolean             udg_TeleportFast
    boolean             udg_GameOver
    boolean             udg_MaySendCommands
...
function CreateUnitsForPlayer3 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'umtw', -1236.0, -7938.6, 257.439 )
...
function CreateUnitsForPlayer9 takes nothing returns nothing
    ...
    call SelectHeroSkill( gg_unit_Huth_0007, 'AHds' )
    call SelectHeroSkill( gg_unit_Huth_0007, 'AHds' )
    call IssueImmediateOrder( gg_unit_Huth_0007, "undivineshield" )
...
function Trig_Initialize_Initializations_Actions takes nothing returns nothing
    ...
    call CommentString( "Cinematic Building Invulnerable" )
    call SetUnitInvulnerable( gg_unit_ncb1_0064, true )
    call CommentString( "Mal'Ganis Altar Invulnerable" )
    call SetUnitInvulnerable( gg_unit_uaod_0019, true )
    call CommentString( "Set Difficulty" )
    call ConditionalTriggerExecute( gg_trg_Difficulty )
    call CommentString( "RAIN" )
...
function Trig_Default_Arthas_Actions takes nothing returns nothing
    ...
    call SetHeroLevel( udg_ArthasVariable, 6, false )
...
function Trig_Alliance_Sight_Color_Actions takes nothing returns nothing
    ...
    call ForGroup( GetUnitsOfPlayerAll(Player(11)), function Trig_Alliance_Sight_Color_Func047002 )
    call ForGroup( GetUnitsOfPlayerAll(Player(10)), function Trig_Alliance_Sight_Color_Func048002 )
endfunction
...
function Trig_Intro_Cancel_Actions takes nothing returns nothing
    ...
    call ForGroup( GetUnitsInRectAll(gg_rct_VillagersESCmove), function Trig_Intro_Cancel_Func008002 )
...
function Trig_Arthas_Gets_Town_Actions takes nothing returns nothing
    ...
    call ForGroup( udg_UthersGroup, function Trig_Arthas_Gets_Town_Func005002 )
    call SetUnitInvulnerable( udg_ArthasVariable, false )
    call ForGroup( GetUnitsInRectAll(gg_rct_Harvest_Gold), function Trig_Arthas_Gets_Town_Func007002 )
    call ForGroup( GetUnitsInRectAll(gg_rct_Harvest_Lumber), function Trig_Arthas_Gets_Town_Func008002 )
...
function Trig_Malganis_First_Teleport_Cin_Skip_Actions takes nothing returns nothing
    ...
    call CommentString( "Clean up the scene" )
    call CinematicModeBJ( false, GetPlayersAll() )
    ...
    call ForGroup( udg_MalganisDeathSquad, function Trig_Malganis_First_Teleport_Cin_Skip_Func016002 )
    call ForGroup( udg_HideUnits, function Trig_Malganis_First_Teleport_Cin_Skip_Func017002 )
    call ForGroup( GetUnitsOfPlayerAll(udg_ThePlayer), function Trig_Malganis_First_Teleport_Cin_Skip_Func018002 )
    call PauseAllUnitsBJ( false )
    call SelectGroupBJ( udg_SelectedUnits )
    call CommentString( "Start AI" )
    ...
    set udg_MalganisFirstTeleCin = false
    call CommentString( "Update leaderboard" )
...
function Trig_Malganis_First_Teleport_Cinematic_Actions takes nothing returns nothing
    ...
    call ForGroup( GetUnitsOfPlayerAll(udg_ThePlayer), function Trig_Malganis_First_Teleport_Cinematic_Func009002 )
    ...
    call ForGroup( udg_MalganisDeathSquad, function Trig_Malganis_First_Teleport_Cinematic_Func014002 )
    call ForGroup( GetUnitsOfPlayerAll(udg_ThePlayer), function Trig_Malganis_First_Teleport_Cinematic_Func015002 )
    call ForGroup( GetUnitsOfPlayerAll(Player(8)), function Trig_Malganis_First_Teleport_Cinematic_Func016002 )
    call ForGroup( GetUnitsOfPlayerAll(Player(2)), function Trig_Malganis_First_Teleport_Cinematic_Func017002 )
    call ForGroup( GetUnitsOfPlayerMatching(udg_ThePlayer, Condition(function Trig_Malganis_First_Teleport_Cinematic_Func018001002)), function Trig_Malganis_First_Teleport_Cinematic_Func018002 )
    call ForGroup( udg_HideUnits, function Trig_Malganis_First_Teleport_Cinematic_Func019002 )
    ...
    call CommentString( "CINEMATIC BEGINS - Cinematic is now skippable" )
    ...
    call ForGroup( udg_MalganisDeathSquad, function Trig_Malganis_First_Teleport_Cinematic_Func034002 )
    call TriggerSleepAction( 0.20 )
    ...
    call DisableTrigger( gg_trg_Malganis_First_Teleport_Cin_Skip )
    call CommentString( "Return to gameplay without a fade" )
    call CinematicModeBJ( false, GetPlayersAll() )
    call CommentString( "Clean up the scene" )
    call ForGroup( udg_HideUnits, function Trig_Malganis_First_Teleport_Cinematic_Func063002 )
    call ForGroup( GetUnitsOfPlayerAll(udg_ThePlayer), function Trig_Malganis_First_Teleport_Cinematic_Func064002 )
    call PauseAllUnitsBJ( false )
    call SelectGroupBJ( udg_SelectedUnits )
    call CommentString( "Start AI" )
    call StartCampaignAI( Player(6), "h06_green.ai" )
    ...
    call CommandAI( Player(6), 6, R2I(udg_MalganisCaptainY) )
    call CommandAI( Player(6), 5, R2I(udg_MalganisCaptainX) )
    call CommentString( "OLD STUFF BELOW LEAVE FOR END OF CIN?" )
    call TriggerExecute( gg_trg_Malganis_First_Building_Attack )
...
function Trig_Malganis_First_Get_Arthas_Alt_Actions takes nothing returns nothing
    call CommentString( "If Arthas was dead, revive him on the spot" )
    call ReviveHeroLoc( udg_ArthasVariable, GetRectCenter(gg_rct_Arthas_Cin_Skip_Move), false )
    call CommentString( "If an Altar exists, move him to the Altar's location" )
...
function Trig_Malganis_AI_and_Level_Actions takes nothing returns nothing
    call SetHeroLevel( udg_MalganisVariable, 6, false )
    if ( Trig_Malganis_AI_and_Level_Func002001() ) then
        call SetHeroLevel( udg_MalganisVariable, 7, false )
    else
        call DoNothing(  )
    endif
    if ( Trig_Malganis_AI_and_Level_Func003001() ) then
        call SetHeroLevel( udg_MalganisVariable, 8, false )
    else
        call DoNothing(  )
    endif
...
function Trig_Malganis_Death_Squad_1_Actions takes nothing returns nothing
    call CommentString( "Malganis is dead, send his units after the player" )
...
function Trig_Teleport_Malganis_Actions takes nothing returns nothing
    ...
    call CommandAI( Player(6), 6, R2I(udg_MalganisCaptainY) )
    call CommandAI( Player(6), 5, R2I(udg_MalganisCaptainX) )
    call ForGroup( udg_MalganisDeathSquad, function Trig_Teleport_Malganis_Func019002 )
...
function Trig_Die_Fool_Actions takes nothing returns nothing
    ...
    call ForGroup( GetUnitsOfPlayerAll(Player(6)), function Trig_Die_Fool_Func023002 )
...
function Trig_Victory_Cinematic_Actions takes nothing returns nothing
    ...
    call ForGroup( GetUnitsInRectAll(GetEntireMapRect()), function Trig_Victory_Cinematic_Func011002 )
    call CinematicModeBJ( true, GetPlayersAll() )
    call ForGroup( GetUnitsInRectOfPlayer(GetEntireMapRect(), Player(6)), function Trig_Victory_Cinematic_Func013002 )
    call ForGroup( GetUnitsInRectOfPlayer(GetEntireMapRect(), Player(1)), function Trig_Victory_Cinematic_Func014002 )
    call ForGroup( GetUnitsInRectOfPlayer(GetEntireMapRect(), Player(3)), function Trig_Victory_Cinematic_Func015002 )
    call ForGroup( GetUnitsInRectOfPlayer(GetEntireMapRect(), Player(8)), function Trig_Victory_Cinematic_Func016002 )
