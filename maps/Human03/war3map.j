...
trigger gg_trg_SetWaterElemental= null
...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem('pman', - 4932.0, 2671.3)
    call CreateItem('rin1', - 6678.4, - 4454.2)
endfunction
...
function CreateUnitsForPlayer3 takes nothing returns nothing
    ...
    set gg_unit_Hjai_0011=CreateUnit(p, 'Hjai', 5927.9, - 3474.8, 187.382)
endfunction
...
function Trig_SetupHeroes_Actions takes nothing returns nothing
    // Jaina
    set udg_Jaina=gg_unit_Hjai_0011
...
function Trig_SetupHeroGroup_Actions takes nothing returns nothing
    ...
    call GroupAddUnitSimple(gg_unit_Hjai_0011, udg_Heroes)
endfunction
...
function Trig_SetupStartingPartyGroup_Actions takes nothing returns nothing
    ...
    call GroupAddUnitSimple(gg_unit_Hjai_0011, udg_StartingParty)
...
function Trig_Load_Heroes_Actions takes nothing returns nothing
    ...
    // Load the hero data
    call RestoreUnitLocFacingAngleBJ("Arthas", "Human03", GetLastCreatedGameCacheBJ(), Player(1), GetRectCenter(gg_rct_ArthasStart), 270.00)
...
function Trig_Next_Level_Prep_Actions takes nothing returns nothing
    ...
    call StoreUnitBJ(udg_Arthas, "Arthas", "Human04", GetLastCreatedGameCacheBJ())
    call StoreUnitBJ(udg_Jaina, "Jaina", "Human04", GetLastCreatedGameCacheBJ())
    call SaveGameCacheBJ(GetLastCreatedGameCacheBJ())
    // Enable the next level in the glue screens
    call SetMissionAvailableBJ(true, bj_MISSION_INDEX_H04)
endfunction
...
function Trig_Next_Level_Run_Actions takes nothing returns nothing
    // Run next level
    call SetNextLevelBJ("Maps\\Campaign\\Human04.w3m")
...
//===========================================================================
// Trigger: SetWaterElemental
//===========================================================================
function Trig_SetWaterElemental_Actions takes nothing returns nothing
    call DisableTrigger(GetTriggeringTrigger())
    set udg_WaterElemental=GetSummonedUnit()
...
//===========================================================================
function InitTrig_SetWaterElemental takes nothing returns nothing
    set gg_trg_SetWaterElemental=CreateTrigger()
    call TriggerRegisterPlayerUnitEventSimple(gg_trg_SetWaterElemental, Player(3), EVENT_PLAYER_UNIT_SUMMON)
    call TriggerAddAction(gg_trg_SetWaterElemental, function Trig_SetWaterElemental_Actions)
endfunction
...
function Trig_OpeningCancelled_Actions takes nothing returns nothing
    ...
    call PauseUnitBJ(false, gg_unit_Hjai_0011)
    ...
    call SetUnitInvulnerable(gg_unit_Hjai_0011, false)
    call SetUnitLifePercentBJ(gg_unit_Hjai_0011, 100.00)
    call SetUnitManaBJ(gg_unit_Hjai_0011, GetUnitStateSwap(UNIT_STATE_MAX_MANA, gg_unit_Hjai_0011))
...
function Trig_Opening01_Actions takes nothing returns nothing
    ...
    call PauseUnitBJ(true, gg_unit_Hjai_0011)
    ...
    call IssuePointOrderLocBJ(gg_unit_Hjai_0011, "move", GetRectCenter(gg_rct_StartJaina))
...
function Trig_JainaKillOgre_Actions takes nothing returns nothing
    ...
    call IssueImmediateOrderBJ(udg_Jaina, "waterelemental")
...
function Trig_Priest_Queue_Func012001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction

function Trig_Priest_Queue_Func020001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction
...
function Trig_Priest_Queue_Func031001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction

function Trig_Priest_Queue_Func037001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction
...
function Trig_Priest_Queue_Actions takes nothing returns nothing
    ...
    call TriggerSleepAction(1.00)
    if ( Trig_Priest_Queue_Func012001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Priest_Queue_Func020001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(bj_QUEUE_DELAY_HINT)
    // ***********************
    if ( Trig_Priest_Queue_Func031001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Priest_Queue_Func037001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_Fountain_Found_Func009001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction

function Trig_Fountain_Found_Func015001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction
...
function Trig_Fountain_Found_Actions takes nothing returns nothing
    ...
    call VolumeGroupResetBJ()
    call TriggerSleepAction(1.00)
    if ( Trig_Fountain_Found_Func009001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(bj_QUEUE_DELAY_QUEST)
    if ( Trig_Fountain_Found_Func015001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_StartDefend_Func028001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction
...
function Trig_StartDefend_Actions takes nothing returns nothing
    ...
    call SetPlayerTechResearchedSwap('Rhde', 1, Player(1))
    ...
    if ( Trig_StartDefend_Func028001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_SkeletonsAllDead_Func005002 takes nothing returns nothing
...
function Trig_SkeletonsAllDead_Func008001 takes nothing returns boolean
...
function Trig_SkeletonsAllDead_Func014002 takes nothing returns nothing
...
function Trig_SkeletonsAllDead_Func017001 takes nothing returns boolean
    return ( udg_GameOver == true )
endfunction
...
function Trig_SkeletonsAllDead_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(udg_FootmenDefending, function Trig_SkeletonsAllDead_Func005002)
    call ForGroupBJ(udg_FootmenDefending, function Trig_SkeletonsAllDead_Func006002)
    call SetSpeechVolumeGroupsBJ()
    if ( Trig_SkeletonsAllDead_Func008001() ) then
    ...
    call VolumeGroupResetBJ()
    call ForGroupBJ(udg_FootmenDefending, function Trig_SkeletonsAllDead_Func014002)
    call ForGroupBJ(udg_FootmenDefending, function Trig_SkeletonsAllDead_Func015002)
    call QueuedTriggerRemoveBJ(GetTriggeringTrigger())
    if ( Trig_SkeletonsAllDead_Func017001() ) then
        return
    else
        call DoNothing()
    endif
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_SetWaterElemental()
