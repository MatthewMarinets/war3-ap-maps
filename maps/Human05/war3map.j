...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set gg_unit_hfoo_0024=CreateUnit(p, 'hfoo', 6722.1, - 7859.2, 168.489)
    set gg_unit_hfoo_0025=CreateUnit(p, 'hfoo', 6645.9, - 7613.7, 203.267)
...
function Trig_SetupHereos_Actions takes nothing returns nothing
    ...
    call SetHeroLevelBJ(udg_Jaina, 6, false)
...
function Trig_SetupPlayers_Actions takes nothing returns nothing
    ...
    set udg_Footman1=gg_unit_hfoo_0024
    set udg_Footman2=gg_unit_hfoo_0025
...
function Trig_Cinematic_D_Func015001 takes nothing returns boolean
    return ( udg_IntroCancelled == true )
endfunction
...
function Trig_Cinematic_D_Actions takes nothing returns nothing
    ...
    call IssueTargetOrderBJ(udg_Jaina, "massteleport", udg_TeleportUnit)
    ...
    if ( Trig_Cinematic_D_Func015001() ) then
        return
    else
        call DoNothing()
    endif
