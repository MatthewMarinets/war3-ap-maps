...
globals
    ...
    boolean             udg_PurpleDefeated
    boolean             udg_GreenDefeated
    ...
    boolean             udg_FrostmourneCinematicRunning
    boolean             udg_FrostmourneCinematicEscape
    unit                udg_Captain                = null
    boolean             udg_ArthasIsEvil
    ...
    boolean             udg_HeroDefeatPossible
    ...
    integer             udg_ScrollsOfTownPortal
    integer             udg_AmuletsOfRecall
    group               udg_UnitGroupSelection     = null
    integer             udg_SkillHolyLight
    integer             udg_SkillDivineShield
    integer             udg_SkillDevotionAura
    integer             udg_SkillResurrection
    location            udg_PointGuardianPosition  = null
    real                udg_RealGuardianFacing
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'nspd', -281.2, -1611.6, 277.226 )
...
function CreateCameras takes nothing returns nothing
    ...
    call CameraSetupSetField( gg_cam_FrostmourneDeathCamera, CAMERA_FIELD_ROTATION, 16.5, 0.0 )
...
function Trig_Initial_ValleyPrep_Actions takes nothing returns nothing
    call ForGroup( GetUnitsOfPlayerAll(Player(PLAYER_NEUTRAL_AGGRESSIVE)), function Trig_Initial_ValleyPrep_Func001002 )
...
function Trig_Initial_IntroWavePrep_Actions takes nothing returns nothing
    call ForGroup( GetUnitsInRectAll(gg_rct_IntroNorthUndeadWave), function Trig_Initial_IntroWavePrep_Func001002 )
    call ForGroup( GetUnitsInRectAll(gg_rct_IntroNortheastUndeadWave), function Trig_Initial_IntroWavePrep_Func002002 )
    call ForGroup( udg_IntroNorthGroup, function Trig_Initial_IntroWavePrep_Func003002 )
    call ForGroup( udg_IntroNortheastGroup, function Trig_Initial_IntroWavePrep_Func004002 )
endfunction
...
function Trig_Initial_Heroes_Actions takes nothing returns nothing
    ...
    call SetHeroLevel( udg_Malganis, 9, false )
...
function Trig_Load_Arthas_Actions takes nothing returns nothing
    ...
    call SetHeroLevel( udg_Arthas, 9, false )
...
function Trig_Load_Muradin_Actions takes nothing returns nothing
    ...
    call SetHeroLevel( udg_Muradin, 7, false )
...
function Trig_ItemFailsafeDetect_Actions takes nothing returns nothing
    ...
    call CommentString( "AMULETS OF RECALL" )
...
function Trig_IntroUndeadApproach_Actions takes nothing returns nothing
    call ForGroup( udg_IntroNorthGroup, function Trig_IntroUndeadApproach_Func001002 )
    call ForGroup( udg_IntroNortheastGroup, function Trig_IntroUndeadApproach_Func002002 )
...
function Trig_IntroLastDwarfReachesWaygate_Actions takes nothing returns nothing
    call DisableTrigger( GetTriggeringTrigger() )
    call ForGroup( GetUnitsInRectAll(gg_rct_IntroArthasWaygateForce), function Trig_IntroLastDwarfReachesWaygate_Func002002 )
    call TriggerSleepAction( 2.50 )
...
function Trig_IntroCinematicEnd_Actions takes nothing returns nothing
    ...
    call SetPlayerStateBJ( Player(1), PLAYER_STATE_RESOURCE_LUMBER, 500 )
    call SetResourceAmount( gg_unit_ngol_0003, 30000 )
    call CommentString( "HANDLE SCROLLS" )
...
function Trig_IntroCinematicEscape_Actions takes nothing returns nothing
    ...
    call ForGroup( udg_IntroNorthGroup, function Trig_IntroCinematicEscape_Func007002 )
    call ForGroup( udg_IntroNortheastGroup, function Trig_IntroCinematicEscape_Func008002 )
...
function Trig_FirstWolves_Actions takes nothing returns nothing
    call DisableTrigger( GetTriggeringTrigger() )
    call ForGroup( GetUnitsInRectAll(gg_rct_ValleyFirstWolves), function Trig_FirstWolves_Func002002 )
endfunction
...
function Trig_GuardianEncounter_Actions takes nothing returns nothing
    ...
    call CommentString( "DIFFICULTY MODIFIER" )
...
function Trig_FrostmourneCinematicSetup_Actions takes nothing returns nothing
    call CommentString( "TURN OFF SKILL LEARNING TRIGGER" )
    ...
    call CommentString( "START MUSIC THEME" )
...
function Trig_FrostmourneActorSetup_Actions takes nothing returns nothing
    call ForGroup( udg_ValleyGroup, function Trig_FrostmourneActorSetup_Func001002 )
...
function Trig_FrostmourneApproach_Actions takes nothing returns nothing
    ...
    call CinematicFadeBJ( bj_CINEFADETYPE_FADEOUT, 0.25, "ReplaceableTextures\\CameraMasks\\White_mask.tga", 100.00, 100.00, 100.00, 0.00 )
...
function Trig_FrostmourneMuradinHit_Actions takes nothing returns nothing
    call CinematicFadeBJ( bj_CINEFADETYPE_FADEIN, 3.00, "ReplaceableTextures\\CameraMasks\\White_mask.tga", 100.00, 100.00, 100.00, 0.00 )
...
function Trig_FrostmourneCinematicEnd_Actions takes nothing returns nothing
    ...
    call ForGroup( udg_ValleyGroup, function Trig_FrostmourneCinematicEnd_Func022002 )
    call CommentString( "MAKE MALGANIS VULNERABLE" )
    ...
    call CinematicModeBJ( false, GetPlayersAll() )
    call CommentString( "ENABLE VICTORY" )
    call EnableTrigger( gg_trg_Green_Base_Dead )
    call CommentString( "RESELECT ARTHAS" )
...
function Trig_FrostmourneCinematicEscapeGood_Actions takes nothing returns nothing
    ...
    call ForGroup( udg_ValleyGroup, function Trig_FrostmourneCinematicEscapeGood_Func043002 )
    call CommentString( "MAKE MALGANIS VULNERABLE" )
    call TriggerExecute( gg_trg_DestroyMalganisItems )
    call DisableTrigger( gg_trg_GiveAnkh )
    call ReplaceUnitBJ( udg_Arthas, 'Harf', bj_UNIT_STATE_METHOD_RELATIVE )
...
function Trig_FrostmourneCinematicEscapeEvil_Actions takes nothing returns nothing
    ...
    call SetSkyModel( null )
    call UseTimeOfDayBJ( true )
    call CommentString( "MURADIN ITEMS" )
    set udg_ItemMuradin01 = UnitItemInSlotBJ(udg_Muradin, 1)
    set udg_ItemMuradin02 = UnitItemInSlotBJ(udg_Muradin, 2)
    set udg_ItemMuradin03 = UnitItemInSlotBJ(udg_Muradin, 3)
    set udg_ItemMuradin04 = UnitItemInSlotBJ(udg_Muradin, 4)
    ...
    call TriggerExecute( gg_trg_ItemFailsafeReplace )
    call GroupRemoveUnitSimple( udg_Arthas, udg_ValleyGroup )
    call ForGroup( udg_ValleyGroup, function Trig_FrostmourneCinematicEscapeEvil_Func036002 )
    call CommentString( "MAKE MALGANIS VULNERABLE" )
    call TriggerExecute( gg_trg_DestroyMalganisItems )
    call DisableTrigger( gg_trg_GiveAnkh )
    call SetUnitPositionLoc( udg_EvilArthas, GetRectCenter(gg_rct_FrostmourneArthasOutside) )
...
function Trig_ExitCinematicSetup_Actions takes nothing returns nothing
    ...
    call CommentString( "PLAY SOUND THEME" )
