...
trigger gg_trg_Load_Muradin= null
...
function CreateBuildingsForPlayer3 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'unp2', 5504.0, - 5184.0, 270.000)
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'ngme', 5504.0, - 1024.0, 270.000)
    set u=CreateUnit(p, 'nmr7', 2176.0, - 5632.0, 270.000)
...
function Trig_Initial_Heroes_Actions takes nothing returns nothing
    ...
    call TriggerExecute(gg_trg_Load_Muradin)
...
function Trig_Load_Arthas_Actions takes nothing returns nothing
    call RestoreUnitLocFacingPointBJ("Arthas", "Human09", GetLastCreatedGameCacheBJ(), Player(1), GetRectCenter(gg_rct_InitPlaceArthas), GetRectCenter(gg_rct_InitArthasLooks))
    ...
    call CreateNUnitsAtLocFacingLocBJ(1, 'Hart', Player(1), GetRectCenter(gg_rct_InitPlaceArthas), GetRectCenter(gg_rct_InitArthasLooks))
...
//===========================================================================
// Trigger: Load Muradin
//===========================================================================
function Trig_Load_Muradin_Func003001 takes nothing returns boolean
    return ( udg_Muradin != null )
endfunction

function Trig_Load_Muradin_Actions takes nothing returns nothing
    call RestoreUnitLocFacingPointBJ("Muradin", "Human09", GetLastCreatedGameCacheBJ(), Player(1), GetRectCenter(gg_rct_InitPlaceMuradin), GetUnitLoc(gg_unit_hmpr_0130))
    set udg_Muradin=GetLastRestoredUnitBJ()
    if ( Trig_Load_Muradin_Func003001() ) then
        return
    else
        call DoNothing()
    endif
    call CreateNUnitsAtLocFacingLocBJ(1, 'Hmbr', Player(1), GetRectCenter(gg_rct_InitPlaceMuradin), GetUnitLoc(gg_unit_hmpr_0130))
    set udg_Muradin=GetLastCreatedUnit()
    call SetHeroLevelBJ(udg_Muradin, 7, false)
...
//===========================================================================
function InitTrig_Load_Muradin takes nothing returns nothing
    set gg_trg_Load_Muradin=CreateTrigger()
    call TriggerAddAction(gg_trg_Load_Muradin, function Trig_Load_Muradin_Actions)
endfunction
...
function Trig_IntroMuradinAsksArthas_Conditions takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetEnteringUnit()) == 'Hmbr' ) ) then
        return false
    endif
    return true
endfunction

function Trig_IntroMuradinAsksArthas_Func006001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction

function Trig_IntroMuradinAsksArthas_Func008001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction

function Trig_IntroMuradinAsksArthas_Func011001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction

function Trig_IntroMuradinAsksArthas_Func013001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction
...
function Trig_IntroMuradinAsksArthas_Actions takes nothing returns nothing
    ...
    if ( Trig_IntroMuradinAsksArthas_Func006001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(0.50)
    if ( Trig_IntroMuradinAsksArthas_Func008001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_IntroMuradinAsksArthas_Func011001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(0.50)
    if ( Trig_IntroMuradinAsksArthas_Func013001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_IntroArthasTalksToCaptain_Conditions takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetEnteringUnit()) == 'Hart' ) ) then
        return false
    endif
    return true
endfunction

function Trig_IntroArthasTalksToCaptain_Func002001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction

function Trig_IntroArthasTalksToCaptain_Func005001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction

function Trig_IntroArthasTalksToCaptain_Func012001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction
...
function Trig_IntroArthasTalksToCaptain_Func015001 takes nothing returns boolean
    return ( udg_IntroCinematicEscape == true )
endfunction

function Trig_IntroArthasTalksToCaptain_Actions takes nothing returns nothing
    call TriggerSleepAction(0.20)
    if ( Trig_IntroArthasTalksToCaptain_Func002001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_IntroArthasTalksToCaptain_Func005001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_IntroArthasTalksToCaptain_Func012001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_IntroArthasTalksToCaptain_Func015001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_FrostmourneCinematicEscapeGood_Func012001 takes nothing returns boolean
...
function Trig_FrostmourneCinematicEscapeGood_Func043002 takes nothing returns nothing
    call RemoveUnit(GetEnumUnit())
endfunction

function Trig_FrostmourneCinematicEscapeGood_Func054001 takes nothing returns boolean
    return ( IsUnitAliveBJ(udg_Captain) == true )
endfunction
...
function Trig_FrostmourneCinematicEscapeGood_Actions takes nothing returns nothing
    ...
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEOUT, 1.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0, 0, 0)
    call TriggerSleepAction(2.00)
    if ( Trig_FrostmourneCinematicEscapeGood_Func012001() ) then
        call DoNothing()
    else
        call FogModifierStart(udg_ValleyVisA)
    endif
    ...
    call ForGroupBJ(udg_ValleyGroup, function Trig_FrostmourneCinematicEscapeGood_Func043002)
    // MAKE MALGANIS VULNERABLE
    call TriggerExecute(gg_trg_DestroyMalganisItems)
    call DisableTrigger(gg_trg_GiveAnkh)
    call ReplaceUnitBJ(udg_Arthas, 'Harf', bj_UNIT_STATE_METHOD_RELATIVE)
    ...
    // RESELECT ARTHAS
    call SelectUnitSingle(udg_EvilArthas)
    if ( Trig_FrostmourneCinematicEscapeGood_Func054001() ) then
...
function Trig_FrostmourneCinematicEscapeEvil_Func036002 takes nothing returns nothing
    call RemoveUnit(GetEnumUnit())
endfunction

function Trig_FrostmourneCinematicEscapeEvil_Func042001 takes nothing returns boolean
    return ( IsUnitAliveBJ(udg_Captain) == true )
endfunction
...
function Trig_FrostmourneCinematicEscapeEvil_Actions takes nothing returns nothing
    ...
    call TriggerExecute(gg_trg_ItemFailsafeReplace)
    call GroupRemoveUnitSimple(udg_Arthas, udg_ValleyGroup)
    call ForGroupBJ(udg_ValleyGroup, function Trig_FrostmourneCinematicEscapeEvil_Func036002)
    // MAKE MALGANIS VULNERABLE
    call TriggerExecute(gg_trg_DestroyMalganisItems)
    call DisableTrigger(gg_trg_GiveAnkh)
    call SetUnitPositionLoc(udg_EvilArthas, GetRectCenter(gg_rct_FrostmourneArthasOutside))
    call SetUnitFacingTimed(udg_EvilArthas, 315.00, 0)
    if ( Trig_FrostmourneCinematicEscapeEvil_Func042001() ) then
        call SetUnitPositionLocFacingBJ(udg_Captain, GetRectCenter(gg_rct_FrostmourneCaptainToArthas), 150.00)
    else
        call CreateNUnitsAtLoc(1, 'hcth', Player(1), GetRectCenter(gg_rct_FrostmourneCaptainToArthas), 150.00)
    endif
...
function Trig_Level_Enabling_Actions takes nothing returns nothing
    call SetCampaignAvailableBJ(true, bj_CAMPAIGN_INDEX_U)
    call SetCinematicAvailableBJ(true, bj_CINEMATICINDEX_HED)
    call SetMissionAvailableBJ(true, bj_MISSION_INDEX_U00)
endfunction
