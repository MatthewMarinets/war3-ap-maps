...
trigger gg_trg_Disable_Arthas= null
...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set gg_unit_Hart_0023=CreateUnit(p, 'Hart', - 3859.1, 2748.8, 310.690)
...
//===========================================================================
function Trig_Map_Initialization_Func114002 takes nothing returns nothing
...
function Trig_Map_Initialization_Func138002 takes nothing returns nothing
    call ShowUnitHide(GetEnumUnit())
endfunction
...
function Trig_Map_Initialization_Actions takes nothing returns nothing
    ...
    set udg_Arthas=gg_unit_Hart_0023
    ...
    call ForGroupBJ(GetUnitsInRectOfPlayer(gg_rct_WarlordAndCrew, Player(0)), function Trig_Map_Initialization_Func114002)
    ...
    call ForGroupBJ(udg_Slavers, function Trig_Map_Initialization_Func135002)
    call ForGroupBJ(udg_KidnappedVillagers, function Trig_Map_Initialization_Func136002)
    call ForGroupBJ(udg_Slavers, function Trig_Map_Initialization_Func137002)
    call ForGroupBJ(udg_KidnappedVillagers, function Trig_Map_Initialization_Func138002)
...
function Trig_Crate02_Actions takes nothing returns nothing
    call DisableTrigger(GetTriggeringTrigger())
    call TriggerSleepAction(0.10)
    call CreateItemLoc('spro', GetRectCenter(gg_rct_Crate02))
endfunction
...
function Trig_Rescue_Footmen_Func004002 takes nothing returns nothing
...
function Trig_Rescue_Footmen_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(udg_RescuableFootmen, function Trig_Rescue_Footmen_Func004002)
    call TriggerSleepAction(1.00)
...
//===========================================================================
// Trigger: Disable Arthas
//===========================================================================
function Trig_Disable_Arthas_Conditions takes nothing returns boolean
...
function Trig_Disable_Arthas_Actions takes nothing returns nothing
    call DisableTrigger(GetTriggeringTrigger())
    call SuspendHeroXPBJ(false, udg_Arthas)
endfunction

//===========================================================================
function InitTrig_Disable_Arthas takes nothing returns nothing
    set gg_trg_Disable_Arthas=CreateTrigger()
    call TriggerRegisterUnitEvent(gg_trg_Disable_Arthas, gg_unit_Hart_0023, EVENT_UNIT_HERO_LEVEL)
    call TriggerAddCondition(gg_trg_Disable_Arthas, Condition(function Trig_Disable_Arthas_Conditions))
    call TriggerAddAction(gg_trg_Disable_Arthas, function Trig_Disable_Arthas_Actions)
endfunction
...
function Trig_Gnolls_are_defeated_Func051001 takes nothing returns boolean
    return ( udg_TimmyQuestFailed == false )
endfunction

function Trig_Gnolls_are_defeated_Func054001 takes nothing returns boolean
    return ( udg_TimmyQuestFailed == false )
endfunction

function Trig_Gnolls_are_defeated_Func059001 takes nothing returns boolean
    return ( udg_TimmyQuestFailed == true )
endfunction

function Trig_Gnolls_are_defeated_Func063001 takes nothing returns boolean
    return ( udg_TimmyQuestFailed == true )
endfunction
...
function Trig_Gnolls_are_defeated_Actions takes nothing returns nothing
    ...
    if ( Trig_Gnolls_are_defeated_Func049001() ) then
        call CreateItemLoc('rde0', GetUnitLoc(udg_Arthas))
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Gnolls_are_defeated_Func051001() ) then
    ...
    if ( Trig_Gnolls_are_defeated_Func054001() ) then
        call QuestMessageBJ(GetPlayersAll(), bj_QUESTMESSAGE_ITEMACQUIRED, "TRIGSTR_389")
    else
        call DoNothing()
    endif
    ...
    // CAN SKIP AGAIN
    call TriggerSleepAction(1.00)
    if ( Trig_Gnolls_are_defeated_Func059001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Gnolls_are_defeated_Func063001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_Menag_Dies_Func009001 takes nothing returns boolean
...
//===========================================================================
function Trig_Ledger_Is_Picked_Up_Conditions takes nothing returns boolean
    if ( not ( GetManipulatedItem() == udg_Ledger ) ) then
        return false
    endif
    return true
endfunction
...
function Trig_Ledger_Is_Picked_Up_Actions takes nothing returns nothing
    ...
    call SetItemDroppableBJ(udg_Ledger, false)
endfunction

//===========================================================================
function InitTrig_Ledger_Is_Picked_Up takes nothing returns nothing
    set gg_trg_Ledger_Is_Picked_Up=CreateTrigger()
    call TriggerRegisterPlayerUnitEventSimple(gg_trg_Ledger_Is_Picked_Up, Player(1), EVENT_PLAYER_UNIT_PICKUP_ITEM)
    call TriggerAddCondition(gg_trg_Ledger_Is_Picked_Up, Condition(function Trig_Ledger_Is_Picked_Up_Conditions))
...
function Trig_Return_Ledger_Conditions takes nothing returns boolean
    ...
    if ( not ( UnitHasItem(udg_Arthas, udg_Ledger) == true ) ) then
        return false
    endif
    if ( not ( udg_BanditQuestFailed == false ) ) then
        return false
...
function Trig_Return_Ledger_Queue_Func010001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction
...
function Trig_Return_Ledger_Queue_Func013001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction

function Trig_Return_Ledger_Queue_Func017001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction
...
function Trig_Return_Ledger_Queue_Func020001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction

function Trig_Return_Ledger_Queue_Func021001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction

function Trig_Return_Ledger_Queue_Func024001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction

function Trig_Return_Ledger_Queue_Func025001 takes nothing returns boolean
    return ( udg_BanditQuestFailed == true )
endfunction

function Trig_Return_Ledger_Queue_Func031001 takes nothing returns boolean
...
function Trig_Return_Ledger_Queue_Actions takes nothing returns nothing
    ...
    if ( Trig_Return_Ledger_Queue_Func010001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Return_Ledger_Queue_Func013001() ) then
        return
    else
        call DoNothing()
    endif
    set udg_IsLedgerReturned=true
    call CreateItemLoc('tstr', GetUnitLoc(udg_Arthas))
    call UnitAddItemSwapped(GetLastCreatedItem(), udg_Arthas)
    if ( Trig_Return_Ledger_Queue_Func017001() ) then
        call TriggerExecute(gg_trg_Abort_Return_Ledger)
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Return_Ledger_Queue_Func020001() ) then
        call TriggerExecute(gg_trg_Abort_Return_Ledger)
    else
        call DoNothing()
    endif
    if ( Trig_Return_Ledger_Queue_Func021001() ) then
        return
    else
        call DoNothing()
    endif
    call VolumeGroupResetBJ()
    call TriggerSleepAction(1.00)
    if ( Trig_Return_Ledger_Queue_Func024001() ) then
        call TriggerExecute(gg_trg_Abort_Return_Ledger)
    else
        call DoNothing()
    endif
    if ( Trig_Return_Ledger_Queue_Func025001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(bj_QUEUE_DELAY_QUEST)
    if ( Trig_Return_Ledger_Queue_Func031001() ) then
...
// Trigger: Victory
//===========================================================================
function Trig_Victory_Func007001 takes nothing returns boolean
    return ( UnitHasItem(udg_Arthas, udg_Ledger) == true )
endfunction
...
function Trig_Victory_Func011002 takes nothing returns nothing
...
function Trig_Victory_Func043001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func045001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func047001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func052001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func060001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func062001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func069001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func071001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func073001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func075001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func077001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func084001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Func092001 takes nothing returns boolean
    return ( UnitHasItem(udg_Arthas, udg_Ledger) == true )
endfunction
...
function Trig_Victory_Actions takes nothing returns nothing
    ...
    call TriggerSleepAction(1.00)
    call ClearSelection()
    if ( Trig_Victory_Func007001() ) then
        call RemoveItem(udg_Ledger)
    else
        call DoNothing()
    endif
    ...
    call ForGroupBJ(GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Victory_Func011002)
    call PauseAllUnitsBJ(true)
    call ForGroupBJ(GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Victory_Func013002)
    ...
    if ( Trig_Victory_Func043001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Func045001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Func047001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Func052001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Func060001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(2.00)
    if ( Trig_Victory_Func062001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(1.00)
    if ( Trig_Victory_Func069001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Func071001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(0.50)
    if ( Trig_Victory_Func073001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Func075001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(0.50)
    if ( Trig_Victory_Func077001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(1.00)
    if ( Trig_Victory_Func084001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call CameraResetSmoothingFactorBJ()
    // Change Mission
    if ( Trig_Victory_Func092001() ) then
        call RemoveItem(udg_Ledger)
    else
        call DoNothing()
    endif
...
function InitTrig_Defeat takes nothing returns nothing
    ...
    call TriggerRegisterUnitEvent(gg_trg_Defeat, gg_unit_Hart_0023, EVENT_UNIT_DEATH)
...
//===========================================================================
function Trig_Next_Level_Prep_Func003001 takes nothing returns boolean
    return ( UnitHasItem(udg_Arthas, udg_Ledger) == true )
endfunction
...
function Trig_Next_Level_Prep_Actions takes nothing returns nothing
    // Save hero data
    call InitGameCacheBJ("Campaigns.w3v")
    if ( Trig_Next_Level_Prep_Func003001() ) then
        call RemoveItem(udg_Ledger)
    else
        call DoNothing()
    endif
