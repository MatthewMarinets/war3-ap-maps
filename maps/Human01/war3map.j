...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set gg_unit_hA00_0053=CreateUnit(p, 'hA00', - 3850.9, 3016.6, 306.433)
    set gg_unit_hA00_0054=CreateUnit(p, 'hA00', - 4102.3, 2799.4, 318.305)
...
function CreateUnitsForPlayer2 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'hA00', 379.6, 1985.0, 249.726)
    set u=CreateUnit(p, 'hA00', 107.0, 2000.5, 296.936)
...
function InitTrig_map_config takes nothing returns nothing
    ...
    set location_names[1]="First Crate Item"
    set location_names[2]="Second Crate Item"
    set location_names[3]="Gnoll Item"
    set location_names[4]="Benedict's Trap Item"
    set location_names[5]="Bandit Item"
    set location_names[6]="Bandit Lord Item"
    set location_names[7]="North Crate Item"
    set location_names[20]="Enlist Thornby"
    set location_names[21]="Rescue Battling Footmen"
    set location_names[22]="Save Timmy"
    set location_names[23]="Return Gerard's Ledger"
    set location_names[24]="Find the Graveyard"
endfunction
//===========================================================================
// Trigger: status
//===========================================================================
...
function Trig_Map_Initialization_Actions takes nothing returns nothing
    ...
    set udg_StartingFootman01=gg_unit_hA00_0053
    set udg_StartingFootman02=gg_unit_hA00_0054
...
function Trig_Recruit_Queue_Func008001 takes nothing returns boolean
    return GetBooleanOr(( udg_ThornbyDies == true ), ( udg_GarthDies == true ))
endfunction
...
function Trig_Recruit_Queue_Actions takes nothing returns nothing
    ...
    call CreateNUnitsAtLoc(1, 'hA00', Player(1), GetRectCenter(gg_rct_Armor02), 270.00)
    ...
    call CreateNUnitsAtLoc(1, 'hA00', Player(1), GetRectCenter(gg_rct_Armor01), 240.00)
...
function Trig_DisableGruntCollision_Conditions takes nothing returns boolean
    if ( not GetBooleanOr(( GetEnteringUnit() == udg_Escort01 ), ( GetEnteringUnit() == udg_Escort02 )) ) then
        return false
    endif
    return true
endfunction
...
function Trig_Remove_Running_Child_Conditions takes nothing returns boolean
    if ( not GetBooleanOr(( GetEnteringUnit() == gg_unit_nC17_0155 ), ( GetEnteringUnit() == gg_unit_nC18_0163 )) ) then
        return false
    endif
    return true
endfunction
...
function Trig_Waterfall_Sight_Go_ByeBye_Func004001001002 takes nothing returns boolean
    return GetBooleanAnd(( IsUnitAliveBJ(GetFilterUnit()) == true ), ( GetOwningPlayer(GetFilterUnit()) == udg_AAAP_Arthas ))
endfunction
