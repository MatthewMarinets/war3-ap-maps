...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'nmrl', - 4588.0, 535.7, 306.937)
    call SetUnitAcquireRange(u, 200.0)
...
function InitTrig_map_config takes nothing returns nothing
    ...
    set location_names[1]="Western Murloc Item"
    set location_names[2]="Western Ogre Item"
    set location_names[3]="Gnoll Poacher Item"
    set location_names[4]="Murloc Hut Item"
    set location_names[5]="Gnoll Item"
    set location_names[6]="West Base Crate Item"
    set location_names[7]="East Base Crate Item"
    set location_names[10]="Gnoll Warden Item"
    set location_names[11]="Searinox Item"
    set location_names[20]="Slay Blademaster"
    set location_names[21]="Establish Base"
    set location_names[22]="Meet Feranor Steeltoe"
    set location_names[23]="Slay Searinox"
    set location_names[24]="Return Searinox's Heart"
    set location_names[25]="Destroy the Orc Base"
endfunction
//===========================================================================
// Trigger: status
//===========================================================================
...
function mercenaries_create_camp takes nothing returns nothing
    ...
    set mercenary_camp=CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'nmrd', -960.0, -832.0, 270.0)
...
function Trig_BarracksConstructed_Conditions takes nothing returns boolean
    ...
    if ( not ((( GetUnitTypeId(GetTriggerUnit()) == 'hbar' )) or (( GetUnitTypeId(GetTriggerUnit()) == 'harm' )) or (( GetUnitTypeId(GetTriggerUnit()) == 'hars' )) or (( GetUnitTypeId(GetTriggerUnit()) == 'hgra' ))) ) then
        return false
    endif
    return true
endfunction
...
function Trig_BarracksConstructed_Queue_Func007001 takes nothing returns boolean
    return GetBooleanAnd(( udg_BaseRequirement02 == true ), ( udg_BaseRequirement03 == false ))
endfunction

function Trig_BarracksConstructed_Queue_Func008001 takes nothing returns boolean
    return GetBooleanAnd(( udg_BaseRequirement02 == false ), ( udg_BaseRequirement03 == false ))
endfunction
...
function Trig_FarmsConstructed_Queue_Func009001 takes nothing returns boolean
    return GetBooleanAnd(( udg_BaseRequirement01 == true ), ( udg_BaseRequirement03 == false ))
endfunction

function Trig_FarmsConstructed_Queue_Func010001 takes nothing returns boolean
    return GetBooleanAnd(( udg_BaseRequirement01 == false ), ( udg_BaseRequirement03 == false ))
endfunction
...
function Trig_FootmenTrained_Queue_Func011001 takes nothing returns boolean
    return GetBooleanAnd(( udg_BaseRequirement01 == true ), ( udg_BaseRequirement02 == true ))
endfunction
...
function Trig_FootmenTrained_Queue_Func013001 takes nothing returns boolean
    return GetBooleanAnd(( udg_BaseRequirement01 == true ), ( udg_BaseRequirement02 == false ))
endfunction
...
function Trig_Blademaster_Cinematic_Queue_Func022001002 takes nothing returns boolean
    return GetBooleanAnd(( IsUnitAliveBJ(GetFilterUnit()) == true ), GetBooleanAnd(( RectContainsUnit(gg_rct_BM_Cinematic_Hide_Player_Units_Here, GetFilterUnit()) == true ), ( IsUnitHiddenBJ(GetFilterUnit()) == false )))
endfunction
...
function Trig_Heart_Cinematic_Conditions takes nothing returns boolean
    ...
    if ( not ( GetPlayerTechMaxAllowedSwap('sehr', udg_AAAP_Arthas) > 0 ) ) then
        return false
    endif
    return true
endfunction
...
function Trig_Heart_Cinematic_Queue_C_Func009001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Heart_Cinematic_Queue_C_Actions takes nothing returns nothing
    ...
    call TriggerSleepAction(5.00)
    if ( Trig_Heart_Cinematic_Queue_C_Func009001() ) then
        call QueuedTriggerRemoveBJ(gg_trg_Heart_Cinematic_Queue)
    else
        call DoNothing()
    endif
