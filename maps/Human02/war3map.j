...
trigger gg_trg_Disable_Arthas_Experience= null
...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'ofor', - 672.0, 3488.0, 270.000)
    set u=CreateUnit(p, 'obea', - 1280.0, 2304.0, 270.000)
    set u=CreateUnit(p, 'obar', - 832.0, 2816.0, 270.000)
endfunction
...
function CreateUnitsForPlayer2 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'hrif', - 252.8, - 2576.7, 258.524)
    set gg_unit_hrif_0017=CreateUnit(p, 'hrif', 71.5, - 2893.5, 264.006)
    set u=CreateUnit(p, 'hrif', 184.0, - 2803.2, 255.660)
...
function CreateUnitsForPlayer9 takes nothing returns nothing
    ...
    call SelectHeroSkill(gg_unit_Huth_0002, 'AHad')
    call SelectHeroSkill(gg_unit_Huth_0002, 'AHad')
    set gg_unit_hpea_0020=CreateUnit(p, 'hpea', - 4067.4, - 3981.1, 343.377)
    set gg_unit_hpea_0021=CreateUnit(p, 'hpea', - 4147.5, - 3873.2, 255.484)
    set gg_unit_hpea_0042=CreateUnit(p, 'hpea', - 4276.2, - 3938.2, 241.047)
...
//===========================================================================
function Trig_Map_Initialization_Func113001 takes nothing returns boolean
    return ( GetGameDifficulty() == MAP_DIFFICULTY_HARD )
endfunction

function Trig_Map_Initialization_Func119002 takes nothing returns nothing
...
function Trig_Map_Initialization_Actions takes nothing returns nothing
    ...
    set udg_Gold01=gg_unit_hpea_0042
    set udg_Gold02=gg_unit_hpea_0021
    set udg_Gold03=gg_unit_hpea_0020
    // Uther's Inventory
    ...
    if ( Trig_Map_Initialization_Func113001() ) then
    ...
    call ForGroupBJ(udg_Villagers, function Trig_Map_Initialization_Func119002)
...
//===========================================================================
function Trig___Load_Arthas_Func004001 takes nothing returns boolean
    return ( udg_Arthas != null )
endfunction

function Trig___Load_Arthas_Actions takes nothing returns nothing
    // Load the hero data
    call RestoreUnitLocFacingAngleBJ("Arthas", "Human02", GetLastCreatedGameCacheBJ(), Player(1), GetRectCenter(gg_rct_ArthasStart), 90.00)
    set udg_Arthas=GetLastRestoredUnitBJ()
    if ( Trig___Load_Arthas_Func004001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_Intro_Cinematic_Actions takes nothing returns nothing
    ...
    call SetUnitOwner(udg_Gold01, udg_AAAP_Arthas, true)
    call SetUnitOwner(udg_Gold02, udg_AAAP_Arthas, true)
    ...
    // ERROR
    set udg_LocationOfGold01=GetUnitLoc(udg_Gold01)
    set udg_LocationOfGold02=GetUnitLoc(udg_Gold02)
    set udg_LocationOfGold03=GetUnitLoc(udg_Gold03)
    call RemoveUnit(udg_Gold01)
    call RemoveUnit(udg_Gold02)
    call RemoveUnit(udg_Gold03)
    call CreateNUnitsAtLoc(1, 'hpea', udg_AAAP_Arthas, udg_LocationOfGold01, 0)
    set udg_Gold01=GetLastCreatedUnit()
    call CreateNUnitsAtLoc(1, 'hpea', udg_AAAP_Arthas, udg_LocationOfGold02, 0)
    set udg_Gold02=GetLastCreatedUnit()
    call CreateNUnitsAtLoc(1, 'hpea', udg_AAAP_Arthas, udg_LocationOfGold03, 0)
    set udg_Gold03=GetLastCreatedUnit()
    call TriggerSleepAction(0.01)
    ...
    call IssueImmediateOrderBJ(udg_Gold01, "autoharvestgold")
    call IssueImmediateOrderBJ(udg_Gold02, "autoharvestgold")
    call IssueImmediateOrderBJ(udg_Gold03, "autoharvestgold")
...
function Trig_Intro_Cinematic_Cancel_Actions takes nothing returns nothing
    ...
    call RemoveUnit(udg_Gold02)
    call RemoveUnit(udg_Gold03)
    call CreateNUnitsAtLoc(1, 'hpea', Player(1), udg_LocationOfGold01, 0)
    set udg_Gold01=GetLastCreatedUnit()
    call CreateNUnitsAtLoc(1, 'hpea', Player(1), udg_LocationOfGold02, 0)
    set udg_Gold02=GetLastCreatedUnit()
    call CreateNUnitsAtLoc(1, 'hpea', Player(1), udg_LocationOfGold03, 0)
    set udg_Gold03=GetLastCreatedUnit()
    call TriggerSleepAction(0.01)
    call IssueImmediateOrderBJ(udg_Gold01, "autoharvestgold")
    call IssueImmediateOrderBJ(udg_Gold02, "autoharvestgold")
...
function Trig_BarracksConstructed_Conditions takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetConstructedStructure()) == 'hbar' ) ) then
        return false
    endif
    return true
endfunction
...
function Trig_BarracksConstructed_Queue_Actions takes nothing returns nothing
    ...
    call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_204")
...
function Trig_FootmenTrained_Queue_Func010001001 takes nothing returns boolean
    return ( udg_BaseRequirement01 == true )
endfunction

function Trig_FootmenTrained_Queue_Func010001002 takes nothing returns boolean
    return ( udg_BaseRequirement02 == true )
endfunction

function Trig_FootmenTrained_Queue_Func010001 takes nothing returns boolean
    return GetBooleanAnd(Trig_FootmenTrained_Queue_Func010001001(), Trig_FootmenTrained_Queue_Func010001002())
endfunction
...
function Trig_FootmenTrained_Queue_Actions takes nothing returns nothing
    ...
    if ( Trig_FootmenTrained_Queue_Func010001() ) then
        call QueuedTriggerRemoveBJ(GetTriggeringTrigger())
    else
        call DoNothing()
    endif
...
function Trig___FootmanPopsOut_Conditions takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetTrainedUnit()) == 'hfoo' ) ) then
        return false
    endif
    return true
endfunction

function Trig___FootmanPopsOut_Func002001 takes nothing returns boolean
    return ( udg_FootmenTrained == 1 )
endfunction

function Trig___FootmanPopsOut_Func003001 takes nothing returns boolean
    return ( udg_FootmenTrained == 2 )
endfunction

function Trig___FootmanPopsOut_Func004001 takes nothing returns boolean
    return ( udg_FootmenTrained == 3 )
endfunction

function Trig___FootmanPopsOut_Func005001 takes nothing returns boolean
    return ( udg_FootmenTrained == 4 )
endfunction

function Trig___FootmanPopsOut_Func006001 takes nothing returns boolean
    return ( udg_FootmenTrained == 5 )
endfunction

function Trig___FootmanPopsOut_Func007001 takes nothing returns boolean
    return ( udg_FootmenTrained == 6 )
endfunction

function Trig___FootmanPopsOut_Actions takes nothing returns nothing
    set udg_FootmenTrained=( udg_FootmenTrained + 1 )
    if ( Trig___FootmanPopsOut_Func002001() ) then
        call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_317")
    else
        call DoNothing()
    endif
    if ( Trig___FootmanPopsOut_Func003001() ) then
        call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_048")
    else
        call DoNothing()
    endif
    if ( Trig___FootmanPopsOut_Func004001() ) then
        call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_045")
    else
        call DoNothing()
    endif
    if ( Trig___FootmanPopsOut_Func005001() ) then
        call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_053")
    else
        call DoNothing()
    endif
    if ( Trig___FootmanPopsOut_Func006001() ) then
        call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_085")
    else
        call DoNothing()
    endif
    if ( Trig___FootmanPopsOut_Func007001() ) then
        call LeaderboardSetPlayerItemLabelBJ(udg_AAAP_Arthas, udg_FootmenLeaderboard, "TRIGSTR_484")
    else
        call DoNothing()
    endif
...
function Trig_Crate01_Is_Destroyed_Actions takes nothing returns nothing
    call CreateItemLoc('spro', GetRectCenter(gg_rct_Crate01))
...
function Trig_Crate02_Is_Destroyed_Actions takes nothing returns nothing
    call CreateItemLoc('phea', GetRectCenter(gg_rct_Crate02))
    call PlaySoundBJ(gg_snd_HeroDropItem1)
endfunction
...
function Trig_Dwarves_Queue_Func012001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction

function Trig_Dwarves_Queue_Func015001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Dwarves_Queue_Func019001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Dwarves_Queue_Func023001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction

function Trig_Dwarves_Queue_Func026001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction

function Trig_Dwarves_Queue_Func027002 takes nothing returns nothing
    call RescueUnitBJ(GetEnumUnit(), udg_AAAP_Arthas, true)
endfunction

function Trig_Dwarves_Queue_Func029001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction

function Trig_Dwarves_Queue_Func040001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Dwarves_Queue_Actions takes nothing returns nothing
    ...
    if ( Trig_Dwarves_Queue_Func012001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Dwarves_Queue_Func015001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Dwarves_Queue_Func019001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Dwarves_Queue_Func023001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(1.00)
    if ( Trig_Dwarves_Queue_Func026001() ) then
        return
    else
        call DoNothing()
    endif
    call ForGroupBJ(udg_Dwarves, function Trig_Dwarves_Queue_Func027002)
    call TriggerSleepAction(2.00)
    if ( Trig_Dwarves_Queue_Func029001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Dwarves_Queue_Func040001() ) then
        return
    else
        call DoNothing()
    endif
    call QuestMessageBJ(udg_AAAPG_Arthas, bj_QUESTMESSAGE_HINT, "TRIGSTR_020")
    call SetPlayerUnitAvailableBJ('hrif', true, udg_AAAP_Arthas)
    call SetPlayerUnitAvailableBJ('hbla', true, udg_AAAP_Arthas)
    call QueuedTriggerRemoveBJ(GetTriggeringTrigger())
endfunction
...
function Trig_Heart_Cinematic_Conditions takes nothing returns boolean
    ...
    if ( not ( UnitHasItemOfTypeBJ(udg_Arthas, 'sehr') == true ) ) then
        return false
    endif
    if ( not ( udg_GameOver == false ) ) then
        return false
...
function Trig_Heart_Cinematic_Queue_Func012001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Heart_Cinematic_Queue_Func017001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Heart_Cinematic_Queue_Func020001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction
...
function Trig_Heart_Cinematic_Queue_Actions takes nothing returns nothing
    ...
    call DestroyEffectBJ(udg_TalkFeranor)
    call RemoveItem(udg_HeartofSearinox)
    call ResetToGameCameraForPlayer(Player(1), 0.00)
    ...
    if ( Trig_Heart_Cinematic_Queue_Func012001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Heart_Cinematic_Queue_Func017001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Heart_Cinematic_Queue_Func020001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_Heart_Cinematic_Queue_B_Actions takes nothing returns nothing
    ...
    // Give Orb
    call CreateItemLoc('ofir', GetUnitLoc(udg_Arthas))
...
function Trig_Drop_Heart_of_Searinox_Actions takes nothing returns nothing
    call DisableTrigger(GetTriggeringTrigger())
    call CreateItemLoc('sehr', GetUnitLoc(gg_unit_nser_0048))
    set udg_HeartofSearinox=GetLastCreatedItem()
    call SetItemInvulnerableBJ(udg_HeartofSearinox, true)
    call TriggerSleepAction(1.00)
...
function Trig_Player_Gets_the_Heart_of_Searinox_Func002001 takes nothing returns boolean
    return ( udg_SearinoxQuestFailed == true )
endfunction

function Trig_Player_Gets_the_Heart_of_Searinox_Actions takes nothing returns nothing
    call SetItemDroppableBJ(udg_HeartofSearinox, false)
    if ( Trig_Player_Gets_the_Heart_of_Searinox_Func002001() ) then
        return
    else
        call DoNothing()
    endif
...
//===========================================================================
// Trigger: Disable Arthas Experience
//===========================================================================
function Trig_Disable_Arthas_Experience_Conditions takes nothing returns boolean
    if ( not ( GetHeroLevel(udg_Arthas) >= 3 ) ) then
        return false
    endif
    return true
endfunction

function Trig_Disable_Arthas_Experience_Actions takes nothing returns nothing
    call SuspendHeroXPBJ(false, udg_Arthas)
endfunction

//===========================================================================
function InitTrig_Disable_Arthas_Experience takes nothing returns nothing
    set gg_trg_Disable_Arthas_Experience=CreateTrigger()
    call TriggerRegisterPlayerUnitEventSimple(gg_trg_Disable_Arthas_Experience, Player(1), EVENT_PLAYER_HERO_LEVEL)
    call TriggerAddCondition(gg_trg_Disable_Arthas_Experience, Condition(function Trig_Disable_Arthas_Experience_Conditions))
    call TriggerAddAction(gg_trg_Disable_Arthas_Experience, function Trig_Disable_Arthas_Experience_Actions)
endfunction
...
function Trig_Victory_Cinematic_Func007001 takes nothing returns boolean
    return ( UnitHasItem(udg_Arthas, udg_HeartofSearinox) == true )
endfunction
...
function Trig_Victory_Cinematic_Actions takes nothing returns nothing
    ...
    if ( Trig_Victory_Cinematic_Func007001() ) then
        call RemoveItem(udg_HeartofSearinox)
    else
        call DoNothing()
    endif
...
//===========================================================================
function Trig_Victory_Queue_Func009002 takes nothing returns nothing
...
function Trig_Victory_Queue_Func015001 takes nothing returns boolean
    return ( IsUnitDeadBJ(udg_Arthas) == true )
endfunction

function Trig_Victory_Queue_Func024001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Queue_Func029001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Queue_Func032001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Queue_Func035001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Queue_Func037001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction

function Trig_Victory_Queue_Func044001 takes nothing returns boolean
    return ( udg_VictorySkipped == true )
endfunction
...
function Trig_Victory_Queue_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Victory_Queue_Func009002)
    ...
    if ( Trig_Victory_Queue_Func015001() ) then
    ...
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEIN, 1.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0, 0, 0)
    call TriggerSleepAction(0.50)
    if ( Trig_Victory_Queue_Func024001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Queue_Func029001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Queue_Func032001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Victory_Queue_Func035001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(0.25)
    if ( Trig_Victory_Queue_Func037001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(2.00)
    if ( Trig_Victory_Queue_Func044001() ) then
        return
    else
        call DoNothing()
    endif
...
//===========================================================================
function Trig_Victory_Cinematic_Cancel_Func003001 takes nothing returns boolean
    return ( UnitHasItem(udg_Arthas, udg_HeartofSearinox) == true )
endfunction
...
function Trig_Victory_Cinematic_Cancel_Func011001 takes nothing returns boolean
    return ( IsUnitDeadBJ(udg_Arthas) == true )
endfunction
...
function Trig_Victory_Cinematic_Cancel_Actions takes nothing returns nothing
    ...
    if ( Trig_Victory_Cinematic_Cancel_Func003001() ) then
        call RemoveItem(udg_HeartofSearinox)
    else
        call DoNothing()
    endif
    ...
    call ForGroupBJ(GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Victory_Cinematic_Cancel_Func006002)
    call ShowUnitShow(udg_Arthas)
    call ShowUnitShow(udg_Uther)
    call UnitRemoveBuffsBJ(bj_REMOVEBUFFS_ALL, udg_Arthas)
    call UnitRemoveBuffsBJ(bj_REMOVEBUFFS_ALL, udg_Uther)
    if ( Trig_Victory_Cinematic_Cancel_Func011001() ) then
        call ReviveHeroLoc(udg_Arthas, GetRectCenter(gg_rct_ArthasFinal), false)
    else
        call DoNothing()
    endif
...
function Trig_Next_Level_Prep_Actions takes nothing returns nothing
    // Save hero data
    call InitGameCacheBJ("Campaigns.w3v")
    call StoreUnitBJ(udg_Arthas, "Arthas", "Human03", GetLastCreatedGameCacheBJ())
    call SaveGameCacheBJ(GetLastCreatedGameCacheBJ())
    // Enable next level
    call SetMissionAvailableBJ(true, bj_MISSION_INDEX_H02)
    call SetMissionAvailableBJ(true, bj_MISSION_INDEX_H03)
endfunction
...
function Trig_Next_Level_Run_Actions takes nothing returns nothing
    // Run next level
    call SetNextLevelBJ("Maps\\Campaign\\Human02Interlude.w3m")
...
function Trig_Defeat_Cheat_Actions takes nothing returns nothing
    call CustomDefeatBJ(udg_AAAP_Arthas, "TRIGSTR_390")
endfunction
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_Disable_Arthas_Experience()
