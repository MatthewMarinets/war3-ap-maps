...
function CreateBuildingsForPlayer9 takes nothing returns nothing
    ...
    set gg_unit_htow_0003=CreateUnit(p, 'htow', - 3776.0, - 4032.0, 270.000)
...
function Trig_Intro_Cinematic_Actions takes nothing returns nothing
    ...
    call TriggerExecute(gg_trg_Create_Gold_Peasants)
...
function Trig_PeasantFakeHarvest_Actions takes nothing returns nothing
    ...
    call IssueTargetOrderBJ(GetTriggerUnit(), "attack", gg_unit_htow_0003)
...
function Trig_Next_Level_Run_Actions takes nothing returns nothing
    // Run next level
    call SetNextLevelBJ("Maps\\AP_Campaign\\Human03.w3x")
