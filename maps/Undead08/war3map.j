...
boolean udg_QuestGoblinMineCompleted= false
...
function Trig_Difficulty_Easy_Actions takes nothing returns nothing
    ...
    // From Normal
    // Blue
    call SetHeroLevelBJ(gg_unit_Hamg_0201, 5, false)
    ...
    call SelectHeroSkill(gg_unit_Hamg_0201, 'AHwe')
    // Red
    call SetHeroLevelBJ(gg_unit_Hamg_0200, 4, false)
    ...
    call SelectHeroSkill(gg_unit_Hamg_0200, 'AHwe')
    // Teal
    call SetHeroLevelBJ(gg_unit_Hamg_0202, 3, false)
...
function Trig_Difficulty_Hard_Actions takes nothing returns nothing
    ...
    // Blue
    call SetHeroLevelBJ(gg_unit_Hamg_0201, 9, false)
    call SuspendHeroXPBJ(false, gg_unit_Hamg_0201)
    call SelectHeroSkill(gg_unit_Hamg_0201, 'AHbz')
    call SelectHeroSkill(gg_unit_Hamg_0201, 'AHbz')
    call SelectHeroSkill(gg_unit_Hamg_0201, 'AHbz')
    ...
    call SelectHeroSkill(gg_unit_Hamg_0201, 'AHwe')
    // Red
    call SetHeroLevelBJ(gg_unit_Hamg_0200, 8, false)
    call SuspendHeroXPBJ(false, gg_unit_Hamg_0200)
    call SelectHeroSkill(gg_unit_Hamg_0200, 'AHbz')
    call SelectHeroSkill(gg_unit_Hamg_0200, 'AHbz')
    call SelectHeroSkill(gg_unit_Hamg_0200, 'AHbz')
    ...
    call SelectHeroSkill(gg_unit_Hamg_0200, 'AHwe')
    // Teal
    call SetHeroLevelBJ(gg_unit_Hamg_0202, 7, false)
    call SuspendHeroXPBJ(false, gg_unit_Hamg_0202)
...
function Trig_Setup_CinematicUnits_Actions takes nothing returns nothing
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_ArchmageArea01), function Trig_Setup_CinematicUnits_Func001002)
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_ArchmageArea02), function Trig_Setup_CinematicUnits_Func002002)
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_GryphonArea), function Trig_Setup_CinematicUnits_Func003002)
endfunction
...
function Trig_Load_KelThuzad_Actions takes nothing returns nothing
    ...
    call SetHeroLevelBJ(udg_KelThuzad, 7, false)
...
function Trig_OpeningCancelled_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(udg_CinematicUnitGroup, function Trig_OpeningCancelled_Func024002)
...
function Trig_Opening01_Actions takes nothing returns nothing
    ...
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEOUT, 3.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0, 0, 0)
...
function Trig_Opening03_Actions takes nothing returns nothing
    ...
    call IssueImmediateOrderBJ(udg_KelThuzad, "holdposition")
    call RemoveUnit(udg_Tichondrius)
    call ForGroupBJ(udg_CinematicUnitGroup, function Trig_Opening03_Func044002)
    call ConditionalTriggerExecute(gg_trg_Shades)
    // ***********************
    call ResetToGameCameraForPlayer(Player(3), 0.00)
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEIN, 1.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0, 0, 0)
...
function Trig_MiningAcolytes_Actions takes nothing returns nothing
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_MiningAcolytes), function Trig_MiningAcolytes_Func001002)
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_Harvesters), function Trig_MiningAcolytes_Func002002)
endfunction
...
function Trig_Ending01_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_EndCin_Hide_Units), function Trig_Ending01_Func007002)
    ...
    call ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(0)), function Trig_Ending01_Func082002)
    call ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(1)), function Trig_Ending01_Func083002)
    call ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(2)), function Trig_Ending01_Func084002)
...
function Trig_ArchmageLevel_Actions takes nothing returns nothing
    call SetHeroLevelBJ(gg_unit_Hamg_0205, 8, false)
