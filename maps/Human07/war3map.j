...
globals
    ...
    boolean             udg_DEBUGIntroSkipped
    boolean             udg_MuradinCinematicEscape
    boolean             udg_MuradinCinematicRunning
    boolean             udg_AquaDead
    boolean             udg_OrangeDead
    boolean             udg_ExitCinematicRunning
    boolean             udg_ExitCinematicEscape
    boolean             udg_ArthasDefeatActive
    boolean             udg_BuildingDefeatActive
...
function Trig_IntroInitialCamera_Actions takes nothing returns nothing
    ...
    call CinematicFadeBJ( bj_CINEFADETYPE_FADEOUT, 0.00, "ReplaceableTextures\\CameraMasks\\Black_mask.tga", 0.00, 0.00, 0.00, 0 )
    ...
    call CinematicFadeBJ( bj_CINEFADETYPE_FADEIN, 1.50, "ReplaceableTextures\\CameraMasks\\Black_mask.tga", 0.00, 0.00, 0.00, 0 )
...
function Trig_Muradin_PositionActors_Actions takes nothing returns nothing
    call ForGroup( GetUnitsSelectedAll(Player(1)), function Trig_Muradin_PositionActors_Func001002 )
    call ClearSelection(  )
    ...
    call ForGroup( GetUnitsOfPlayerAll(Player(PLAYER_NEUTRAL_AGGRESSIVE)), function Trig_Muradin_PositionActors_Func005002 )
    call ForGroup( GetUnitsOfPlayerAll(Player(1)), function Trig_Muradin_PositionActors_Func006002 )
    call ForGroup( udg_ArthasGroup, function Trig_Muradin_PositionActors_Func007002 )
    call ForGroup( udg_ArthasGroup, function Trig_Muradin_PositionActors_Func008002 )
...
function Trig_Muradin_FindGoldMine_Actions takes nothing returns nothing
    ...
    call ForGroup( udg_ArthasGroup, function Trig_Muradin_FindGoldMine_Func007002 )
...
function Trig_Muradin_End_Actions takes nothing returns nothing
    ...
    call CommentString( "CREATE STRUCTURES" )
    ...
    call CinematicModeBJ( false, GetPlayersAll() )
    call CommentString( "RESET PATROLS" )
    call ConditionalTriggerExecute( gg_trg_RestartCreepPatrols )
    call CommentString( "GIVE MURADIN TO PLAYER" )
    call ForGroup( GetUnitsOfPlayerAll(Player(7)), function Trig_Muradin_End_Func026002 )
    call SelectHeroSkill( udg_Muradin, 'AHtb' )
    call CommentString( "ACTIVATE AI" )
    call CommandAI( Player(6), 0, 0 )
    call CommandAI( udg_PlayerCryptFiend, 0, 0 )
    call CommentString( "RESET ALLIANCES" )
    call SetPlayerAllianceBJ( Player(8), ALLIANCE_SHARED_VISION, true, Player(1) )
    ...
    call CommentString( "RESET HEROES" )
    ...
    call CommentString( "RESET SELECTION" )
    call SelectGroupBJ( udg_UnitGroupSelection )
    call CommentString( "QUEST SETUP" )
...
function Trig_Muradin_CinematicEscape_Actions takes nothing returns nothing
    call CommentString( "COMMON ESCAPE" )
    call DisableTrigger( GetTriggeringTrigger() )
    call StopSoundBJ( GetLastPlayedSound(), true )
    ...
    call ConditionalTriggerExecute( gg_trg_RestartCreepPatrols )
    call CommentString( "GIVE MURADIN TO PLAYER" )
    call ForGroup( GetUnitsOfPlayerAll(Player(7)), function Trig_Muradin_CinematicEscape_Func021002 )
    call SelectHeroSkill( udg_Muradin, 'AHtb' )
...
function Trig_RescueDwarves_Actions takes nothing returns nothing
    ...
    call ForGroup( GetUnitsOfPlayerAll(Player(8)), function Trig_RescueDwarves_Func003002 )
    call QueuedTriggerAddBJ( gg_trg_Rescue_Dwarves_Message, true )
    call TriggerSleepAction( 0.50 )
    call ForGroup( GetUnitsInRectMatching(gg_rct_CaptiveDwarfPeasantsReharvest, Condition(function Trig_RescueDwarves_Func006001002)), function Trig_RescueDwarves_Func006002 )
    call TriggerSleepAction( 3.00 )
    call ForGroup( GetUnitsInRectMatching(gg_rct_CaptiveDwarfPeasantsReharvest, Condition(function Trig_RescueDwarves_Func008001002)), function Trig_RescueDwarves_Func008002 )
...
function Trig_Exit_Position_Actors_Actions takes nothing returns nothing
    call ClearSelection(  )
    call ForGroup( GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Exit_Position_Actors_Func002002 )
    call ShowUnitShow( udg_Arthas )
    call ShowUnitShow( udg_Muradin )
    call ShowUnitShow( udg_Captain )
    call ForGroup( GetUnitsOfPlayerAll(Player(1)), function Trig_Exit_Position_Actors_Func006002 )
