...
unit gg_unit_hA00_0022= null
unit gg_unit_nwwf_0106= null
unit gg_unit_hA00_0110= null
...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set gg_unit_hA00_0022=CreateUnit(p, 'hA00', - 3665.5, - 5374.5, 265.225)
    set gg_unit_hfoo_0023=CreateUnit(p, 'hfoo', - 3620.5, - 5559.2, 250.429)
    ...
    set gg_unit_hA00_0110=CreateUnit(p, 'hA00', - 3904.3, - 5358.0, 256.365)
endfunction
...
function CreateBuildingsForPlayer3 takes nothing returns nothing
    ...
    set gg_unit_unpl_0036=CreateUnit(p, 'unpl', 2880.0, 4544.0, 270.000)
endfunction
...
function mercenaries_create_camp takes nothing returns nothing
    ...
    set mercenary_camp=CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'nmrd', 2176.0, -4672.0, 270.0)
    call SetUnitColor(mercenary_camp, ConvertPlayerColor(1))
endfunction
...
function Trig_AP_Load_Arthas_Actions takes nothing returns nothing
    // Load the hero data
    set udg_Arthas=hero_create(0, USER_PLAYER, GetRectCenterX(gg_rct_IntroArthasInitial), GetRectCenterY(gg_rct_IntroArthasInitial), 257)
    ...
    set udg_Arthas=CreateUnit(USER_PLAYER, 'Hart', GetRectCenterX(gg_rct_IntroArthasInitial), GetRectCenterY(gg_rct_IntroArthasInitial), 257)
...
function Trig_AP_Load_Muradin_Actions takes nothing returns nothing
    // Load the hero data
    set udg_Muradin=hero_create(1, Player(7), 3993.21, -3015.25, 1.0248675346374512)
    ...
    // If the hero data wasn't found, create a default hero
    set udg_Muradin=CreateUnit(Player(7), 'Hmbr', 3993.21, -3015.25, 1.0248675346374512)
...
function InitTrig_Purple_Base_Location takes nothing returns nothing
    ...
    call TriggerRegisterUnitEvent(gg_trg_Purple_Base_Location, gg_unit_unpl_0036, EVENT_UNIT_DEATH)
...
function InitTrig_Green_Lich_Location takes nothing returns nothing
    ...
    call TriggerRegisterUnitEvent(gg_trg_Green_Lich_Location, gg_unit_Ulic_0100, EVENT_UNIT_DEATH)
...
function Trig_InitializeVariables_Actions takes nothing returns nothing
    set udg_Captain=gg_unit_hfoo_0023
endfunction
...
function Trig_NerubianSeerDeath_Actions takes nothing returns nothing
    call CreateItemLoc('I012', GetUnitLoc(GetDyingUnit()))
endfunction
...
function Trig_Ice_Troll_Attacks_Conditions takes nothing returns boolean
    if ( not GetBooleanOr(( GetUnitTypeId(GetAttacker()) == 'nitr' ), GetBooleanOr(( GetUnitTypeId(GetAttacker()) == 'nitp' ), ( GetUnitTypeId(GetAttacker()) == 'nits' ))) ) then
        return false
    endif
...
function Trig_HutDies_Actions takes nothing returns nothing
    call TriggerSleepAction(0.20)
    call CreateItemLoc('I014', GetRandomLocInRect(gg_rct_IceTrollHut))
endfunction
...
function Trig_Muradin_PositionActors_Actions takes nothing returns nothing
    ...
    call SetUnitPositionLoc(gg_unit_hA00_0022, GetRectCenter(gg_rct_TeleportFootman02))
    call SetUnitPositionLoc(gg_unit_hA00_0110, GetRectCenter(gg_rct_TeleportFootman03))
    ...
    call IssuePointOrderLocBJ(gg_unit_hA00_0022, "move", GetRectCenter(gg_rct_MuradinIntro_Footman02Move))
    call IssuePointOrderLocBJ(gg_unit_hA00_0110, "move", GetRectCenter(gg_rct_MuradinIntro_Footman03Move))
...
function Trig_Muradin_FindGoldMine_Func040001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func043001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction
...
function Trig_Muradin_FindGoldMine_Func052001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func063001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction
...
function Trig_Muradin_FindGoldMine_Func070001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func080001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction
...
function Trig_Muradin_FindGoldMine_Func086001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func097001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func100001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func103001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction

function Trig_Muradin_FindGoldMine_Func105001 takes nothing returns boolean
    return ( udg_MuradinCinematicEscape == true )
endfunction
...
function Trig_Muradin_FindGoldMine_Actions takes nothing returns nothing
    ...
    // AP - changing things here to create a temporary unit to shoot the stormbolt
    set udg_storm_bolter=CreateUnit(Player(7), 'Hmbr', 3893.21, -3115.25, 1.0248675346374512)
    call SelectHeroSkill(udg_storm_bolter, 'AHtb')
    call IssueTargetOrderBJ(udg_storm_bolter, "thunderbolt", gg_unit_hpea_0087)
    call TriggerSleepAction(1.00)
    call RemoveUnit(udg_storm_bolter)
    if ( Trig_Muradin_FindGoldMine_Func040001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(0.50)
    if ( Trig_Muradin_FindGoldMine_Func043001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(0.40)
    if ( Trig_Muradin_FindGoldMine_Func052001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Muradin_FindGoldMine_Func063001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Muradin_FindGoldMine_Func070001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call IssuePointOrderLocBJ(gg_unit_hA00_0022, "move", GetRectCenter(gg_rct_MuradinIntro_Footman02MoveAfter))
    call IssuePointOrderLocBJ(gg_unit_hA00_0110, "move", GetRectCenter(gg_rct_MuradinIntro_Footman03MoveAfter))
    call IssuePointOrderLocBJ(udg_Captain, "move", GetRectCenter(gg_rct_MuradinIntro_CaptainMoveAfter))
    ...
    if ( Trig_Muradin_FindGoldMine_Func080001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(4.00)
    if ( Trig_Muradin_FindGoldMine_Func086001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(0.01)
    if ( Trig_Muradin_FindGoldMine_Func097001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Muradin_FindGoldMine_Func100001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Muradin_FindGoldMine_Func103001() ) then
        return
    else
        call DoNothing()
    endif
    call TriggerSleepAction(0.50)
    if ( Trig_Muradin_FindGoldMine_Func105001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_Muradin_CinematicEscape_Actions takes nothing returns nothing
    ...
    call SetUnitPositionLoc(gg_unit_hA00_0022, GetRectCenter(gg_rct_MuradinIntro_Footman02MoveAfter))
    call SetUnitPositionLoc(gg_unit_hA00_0110, GetRectCenter(gg_rct_MuradinIntro_Footman03MoveAfter))
...
function Trig_Dwarves_Spotted_Conditions takes nothing returns boolean
    ...
    if ( not GetBooleanOr(( GetEnteringUnit() == udg_Arthas ), ( GetEnteringUnit() == udg_Muradin )) ) then
        return false
    endif
    return true
endfunction
...
function Trig_Dwarves_Spotted_Message_Conditions takes nothing returns boolean
    if ( not GetBooleanOr(GetBooleanAnd(( RectContainsUnit(gg_rct_TriggerDwarvesFound, udg_Arthas) == true ), ( IsUnitAliveBJ(udg_Arthas) == true )), GetBooleanAnd(( RectContainsUnit(gg_rct_TriggerDwarvesFound, udg_Muradin) == true ), ( IsUnitAliveBJ(udg_Muradin) == true ))) ) then
        return false
    endif
    if ( not ( udg_GameOver == false ) ) then
        return false
...
function Trig_Dwarves_Spotted_Message_Func009001 takes nothing returns boolean
    return GetBooleanAnd(( DistanceBetweenPoints(GetUnitLoc(udg_Muradin), GetRectCenter(gg_rct_TriggerDwarvesFound)) <= 2560.00 ), ( IsUnitAliveBJ(udg_Muradin) == true ))
endfunction

function Trig_Dwarves_Spotted_Message_Func010001 takes nothing returns boolean
    return GetBooleanAnd(( DistanceBetweenPoints(GetUnitLoc(udg_Arthas), GetRectCenter(gg_rct_TriggerDwarvesFound)) <= 2560.00 ), ( IsUnitAliveBJ(udg_Arthas) == true ))
endfunction
...
function Trig_RescueDwarves_Func004002 takes nothing returns nothing
    call RescueUnitBJ(GetEnumUnit(), Player(1), true)
endfunction

function Trig_RescueDwarves_Func007001002 takes nothing returns boolean
    return ( GetUnitTypeId(GetFilterUnit()) == 'hpea' )
endfunction

function Trig_RescueDwarves_Func007002 takes nothing returns nothing
    call IssueImmediateOrderBJ(GetEnumUnit(), "returnresources")
endfunction

function Trig_RescueDwarves_Func009001002 takes nothing returns boolean
    return ( GetUnitTypeId(GetFilterUnit()) == 'hpea' )
endfunction

function Trig_RescueDwarves_Func009002 takes nothing returns nothing
...
function Trig_RescueDwarves_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(8)), function Trig_RescueDwarves_Func004002)
    call QueuedTriggerAddBJ(gg_trg_Rescue_Dwarves_Message, true)
    call TriggerSleepAction(0.50)
    call ForGroupBJ(GetUnitsInRectMatching(gg_rct_CaptiveDwarfPeasantsReharvest, Condition(function Trig_RescueDwarves_Func007001002)), function Trig_RescueDwarves_Func007002)
    call TriggerSleepAction(3.00)
    call ForGroupBJ(GetUnitsInRectMatching(gg_rct_CaptiveDwarfPeasantsReharvest, Condition(function Trig_RescueDwarves_Func009001002)), function Trig_RescueDwarves_Func009002)
...
function Trig_CheckGreenBuildings_Func003001001002 takes nothing returns boolean
    return GetBooleanAnd(GetBooleanAnd(( IsUnitType(GetFilterUnit(), UNIT_TYPE_STRUCTURE) == true ), ( GetUnitTypeId(GetFilterUnit()) != 'uzg1' )), GetBooleanAnd(( GetUnitTypeId(GetFilterUnit()) != 'uzig' ), ( IsUnitAliveBJ(GetFilterUnit()) == true )))
endfunction
