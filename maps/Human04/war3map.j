...
function Trig_Load_Jaina_Actions takes nothing returns nothing
    ...
    call SetHeroLevelBJ(udg_Jaina, 2, false)
...
function Trig_Granary01_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(6)), function Trig_Granary01_Func008002)
    ...
    call ClearSelection()
    call ForGroupBJ(GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Granary01_Func015002)
    // Music
...
function Trig_Ending_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(5)), function Trig_Ending_Func026002)
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(6)), function Trig_Ending_Func027002)
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(1)), function Trig_Ending_Func028002)
    call ShowUnitShow(udg_KelThuzad)
    call ShowUnitShow(udg_Arthas)
    call ShowUnitShow(udg_Jaina)
    call ForGroupBJ(udg_EndCinematicMove, function Trig_Ending_Func032002)
