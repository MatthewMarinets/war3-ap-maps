globals
    // User-defined
boolean udg_OpeningSkipped= false
group udg_Town01Group= null
group udg_PeonGroup01= null
boolean udg_JainaDiesSkipped= false
boolean udg_GranaryCancelled= false
...
unit udg_Timmy= null
boolean udg_MedivhCancelled= false
boolean udg_WaygateCancelled= false
boolean udg_ArthasDead= false
...
unit udg_ShopEast= null
unit udg_ShopNorth= null
...
trigger gg_trg_Base_Location= null
...
constant integer MISSION_ID= 104
...
function InitSounds takes nothing returns nothing
    ...
    call SetSoundDuration(gg_snd_H04Acolyte03, 4754)
    ...
    call SetSoundDuration(gg_snd_H04Arthas02, 2638)
    ...
    call SetSoundDuration(gg_snd_H04Arthas04, 5381)
    ...
    call SetSoundDuration(gg_snd_H04Arthas07, 1776)
    ...
    call SetSoundDuration(gg_snd_H04Arthas09, 5407)
    ...
    call SetSoundDuration(gg_snd_H04Arthas11, 2951)
    ...
    call SetSoundDuration(gg_snd_H04Arthas15, 1854)
    ...
    call SetSoundDuration(gg_snd_H04Arthas17, 1541)
    ...
    call SetSoundDuration(gg_snd_H04Arthas18, 5903)
    ...
    call SetSoundDuration(gg_snd_H04Arthas19, 4466)
    ...
    call SetSoundDuration(gg_snd_H04Arthas21, 2560)
    ...
    call SetSoundDuration(gg_snd_H04Arthas22, 5276)
    ...
    call SetSoundDuration(gg_snd_H04Arthas26, 3213)
    ...
    call SetSoundDuration(gg_snd_H04Jaina01, 5355)
    ...
    call SetSoundDuration(gg_snd_H04Jaina05, 1358)
    ...
    call SetSoundDuration(gg_snd_H04KelThuzad06, 13139)
    ...
    call SetSoundDuration(gg_snd_H04KelThuzad23, 8777)
    ...
    call SetSoundDuration(gg_snd_H04KelThuzad25, 10866)
    ...
    call SetSoundDuration(gg_snd_H04KelThuzad27, 9351)
    ...
    call SetSoundDuration(gg_snd_H04KelThuzad28, 12355)
    ...
    call SetSoundDuration(gg_snd_H04Jaina24, 992)
    ...
    call SetSoundDuration(gg_snd_NecromancerDeath, 2002)
endfunction
...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set gg_unit_hmtm_0055=CreateUnit(p, 'hmtm', - 3576.8, - 6028.9, 274.129)
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    call TriggerRegisterUnitEvent(t, gg_unit_nftb_0009, EVENT_UNIT_CHANGE_OWNER)
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set gg_unit_nC03_0004=CreateUnit(p, 'nC03', - 2624.0, 5440.0, 270.000)
    ...
    set gg_unit_nC02_0079=CreateUnit(p, 'nC02', 1152.0, - 1536.0, 270.000)
endfunction
...
function InitTrig_map_config takes nothing returns nothing
    ...
    set location_names[2]="Troll Item"
    set location_names[3]="Timmy Item"
    set location_names[4]="Gnoll Hut Item"
    set location_names[5]="Murloc Nightcrawler Item"
    set location_names[6]="Enforcer Item"
    set location_names[7]="Troll Hut Item"
    set location_names[8]="Center Goblin Merchant"
    set location_names[9]="North Goblin Merchant"
    set location_names[20]="Destroy the Undead Base"
    set location_names[21]="Investigate Andorhal"
endfunction
//===========================================================================
// Trigger: status
//===========================================================================
...
function Trig_AP_Load_Arthas_Actions takes nothing returns nothing
    // Load the hero data
    set udg_Arthas=hero_create(0, USER_PLAYER, GetRectCenterX(gg_rct_ArthasStart), GetRectCenterY(gg_rct_ArthasStart), 300.0)
    ...
    set udg_Arthas=CreateUnit(USER_PLAYER, 'Hart', GetRectCenterX(gg_rct_ArthasStart), GetRectCenterY(gg_rct_ArthasStart), 300.0)
...
function Trig_AP_Load_Jaina_Actions takes nothing returns nothing
    // Load the hero data
    set udg_Jaina=hero_create(1, USER_PLAYER, GetRectCenterX(gg_rct_JainaStart), GetRectCenterY(gg_rct_JainaStart), 300.0)
...
function Trig_Shop_Locations_Actions takes nothing returns nothing
    set udg_ShopEast=gg_unit_nC02_0079
    set udg_ShopNorth=gg_unit_nC03_0004
    call AddItemToStockBJ('I018', udg_ShopEast, 1, 1)
    call AddItemToStockBJ('I019', udg_ShopNorth, 1, 1)
endfunction
...
//===========================================================================
// Trigger: Base Location
//===========================================================================
function Trig_Base_Location_Conditions takes nothing returns boolean
...
function Trig_Base_Location_Actions takes nothing returns nothing
    call status_check_location(20)
    call DisableTrigger(GetTriggeringTrigger())
endfunction

//===========================================================================
function InitTrig_Base_Location takes nothing returns nothing
    set gg_trg_Base_Location=CreateTrigger()
    call TriggerRegisterPlayerUnitEventSimple(gg_trg_Base_Location, Player(6), EVENT_PLAYER_UNIT_DEATH)
    call TriggerAddCondition(gg_trg_Base_Location, Condition(function Trig_Base_Location_Conditions))
    call TriggerAddAction(gg_trg_Base_Location, function Trig_Base_Location_Actions)
endfunction
...
function Trig_SetupCreepsSleeping_Actions takes nothing returns nothing
    call DisableTrigger(GetTriggeringTrigger())
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_PatrolForestTroll01Start), function Trig_SetupCreepsSleeping_Func002002)
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_PatrolForestTroll02Start), function Trig_SetupCreepsSleeping_Func003002)
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_GnollRun), function Trig_SetupCreepsSleeping_Func004002)
endfunction
...
function Trig_Hero_Revive_Hint_With_Altar_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfPlayerMatching(Player(1), Condition(function Trig_Hero_Revive_Hint_With_Altar_Func002001002)), function Trig_Hero_Revive_Hint_With_Altar_Func002002)
    call ForGroupBJ(GetUnitsOfPlayerMatching(Player(1), Condition(function Trig_Hero_Revive_Hint_With_Altar_Func003001002)), function Trig_Hero_Revive_Hint_With_Altar_Func003002)
endfunction
...
function Trig_Opening06_Actions takes nothing returns nothing
    ...
    call SelectUnitSingle(udg_Arthas)
    call PanCameraToTimedLocForPlayer(Player(1), GetRectCenter(gg_rct_OpeningCamReset), 0)
    call ForGroupBJ(udg_Town01Group, function Trig_Opening06_Func024002)
    call ForGroupBJ(GetUnitsInRectMatching(gg_rct_AcolyteExit, Condition(function Trig_Opening06_Func025001002)), function Trig_Opening06_Func025002)
    call ConditionalTriggerExecute(gg_trg_StartCampaignAI)
    call DestroyFogModifier(GetLastCreatedFogModifier())
    call EnableTrigger(gg_trg_TownIsDestroyed)
    call QuestSetDiscoveredBJ(udg_QuestAndorhal, true)
...
function Trig_GranaryCancelled_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(6)), function Trig_GranaryCancelled_Func007002)
...
function Trig_Granary01_Func008001 takes nothing returns boolean
    return ( udg_GAMEOVER == true )
endfunction

function Trig_Granary01_Func009002 takes nothing returns nothing
    call ShowUnitHide(GetEnumUnit())
endfunction

function Trig_Granary01_Func016002 takes nothing returns nothing
...
function Trig_Granary01_Func046001 takes nothing returns boolean
...
function Trig_Granary01_Func053001 takes nothing returns boolean
    return ( udg_GranaryCancelled == true )
endfunction
...
function Trig_Granary01_Actions takes nothing returns nothing
    ...
    call UseTimeOfDayBJ(false)
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEOUT, 1.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0.00, 0, 0)
    call PauseAllUnitsBJ(true)
    call TriggerSleepAction(1.00)
    if ( Trig_Granary01_Func008001() ) then
        return
    else
        call DoNothing()
    endif
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(6)), function Trig_Granary01_Func009002)
    ...
    call ClearSelection()
    call ForGroupBJ(GetUnitsInRectAll(GetPlayableMapRect()), function Trig_Granary01_Func016002)
    // Music
    ...
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEIN, 1.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0.00, 0, 0)
    // NOW SKIPPABLE
    ...
    if ( Trig_Granary01_Func046001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Granary01_Func053001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_Granary02_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(6)), function Trig_Granary02_Func067002)
    call SetUnitPositionLoc(udg_KelThuzad, GetRectCenter(gg_rct_KelThuzadFinalPost))
    call SetUnitFacingToFaceLocTimed(udg_KelThuzad, GetRectCenter(gg_rct_KelThuzadFinalFace), 0)
    call SetUnitInvulnerable(udg_KelThuzad, false)
    call PauseAllUnitsBJ(false)
...
function Trig_Ending_Func020001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func025002 takes nothing returns nothing
    call ShowUnitHide(GetEnumUnit())
endfunction
...
function Trig_Ending_Func031002 takes nothing returns nothing
...
function Trig_Ending_Func039001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func045001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func054001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func058001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func061001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func064001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func072001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction

function Trig_Ending_Func084001 takes nothing returns boolean
    return ( udg_EndingCancelled == true )
endfunction
...
function Trig_Ending_Actions takes nothing returns nothing
    ...
    if ( Trig_Ending_Func020001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(5)), function Trig_Ending_Func025002)
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(6)), function Trig_Ending_Func026002)
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(1)), function Trig_Ending_Func027002)
    call ShowUnitShow(udg_KelThuzad)
    call ShowUnitShow(udg_Arthas)
    call ShowUnitShow(udg_Jaina)
    call ForGroupBJ(udg_EndCinematicMove, function Trig_Ending_Func031002)
    ...
    call TriggerSleepAction(0.10)
    if ( Trig_Ending_Func039001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call CinematicFadeBJ(bj_CINEFADETYPE_FADEIN, 1.00, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0, 0, 0)
    call TriggerSleepAction(1.00)
    if ( Trig_Ending_Func045001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(1.00)
    if ( Trig_Ending_Func054001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Ending_Func058001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(2.50)
    if ( Trig_Ending_Func061001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    if ( Trig_Ending_Func064001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call TriggerSleepAction(2)
    // Experimental Death
    if ( Trig_Ending_Func072001() ) then
        return
    else
        call DoNothing()
    endif
    ...
    call EndThematicMusicBJ()
    call TriggerSleepAction(1.00)
    if ( Trig_Ending_Func084001() ) then
        return
    else
        call DoNothing()
    endif
...
function Trig_TimmyDies_Actions takes nothing returns nothing
    call CreateItemLoc('I013', GetUnitLoc(GetDyingUnit()))
endfunction
...
function Trig_ForestTroll_Actions takes nothing returns nothing
    call DisableTrigger(GetTriggeringTrigger())
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_PatrolForestTroll01Start), function Trig_ForestTroll_Func002002)
    call ForGroupBJ(GetUnitsInRectAll(gg_rct_PatrolForestTroll02Start), function Trig_ForestTroll_Func003002)
endfunction
...
function Trig_Golems_Actions takes nothing returns nothing
    call ForGroupBJ(udg_GolemsGroup, function Trig_Golems_Func002002)
endfunction
...
function Trig_ArthasCinematicRevive_Func006001001002 takes nothing returns boolean
    return GetBooleanAnd(( GetUnitTypeId(GetFilterUnit()) == 'halt' ), ( IsUnitAliveBJ(GetFilterUnit()) == true ))
endfunction
...
function Trig_ArthasCinematicRevive_Actions takes nothing returns nothing
    ...
    set udg_RevivalAltar=GroupPickRandomUnit(GetUnitsOfPlayerMatching(Player(1), Condition(function Trig_ArthasCinematicRevive_Func006001001002)))
...
function Trig_JainaCinematicRevive_Func006001001002 takes nothing returns boolean
    return GetBooleanAnd(( GetUnitTypeId(GetFilterUnit()) == 'halt' ), ( IsUnitAliveBJ(GetFilterUnit()) == true ))
endfunction
...
function Trig_JainaCinematicRevive_Actions takes nothing returns nothing
    ...
    set udg_RevivalAltar=GroupPickRandomUnit(GetUnitsOfPlayerMatching(Player(1), Condition(function Trig_JainaCinematicRevive_Func006001001002)))
...
function Trig_TownIsDestroyed_Func005001001002 takes nothing returns boolean
    return GetBooleanAnd(( IsUnitType(GetFilterUnit(), UNIT_TYPE_STRUCTURE) == true ), ( IsUnitAliveBJ(GetFilterUnit()) == true ))
endfunction
