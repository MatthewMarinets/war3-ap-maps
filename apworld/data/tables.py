...
MISSION_TO_HERO_SLOT = {
    ...
    Wc3Mission.NX5_BALANCING_THE_SCALES: [HeroSlot.MAIEV, HeroSlot.TYRANDE_TFT, HeroSlot.MALFURION],
    Wc3Mission.NX6_SHARDS_OF_THE_ALLIANCE: [HeroSlot.MAIEV, HeroSlot.TYRANDE_TFT],
    Wc3Mission.NX7_THE_RUINS_OF_DALARAN: [HeroSlot.MAIEV, HeroSlot.MALFURION],
    Wc3Mission.NX8_THE_BROTHERS_STORMRAGE: [HeroSlot.MALFURION, HeroSlot.ILLIDAN],
...
CAMPAIGN_TO_ITEM_SLOT: dict[Wc3Campaign, tuple[ItemChannel, ItemChannel]] = {
    ...
    Wc3Campaign.HUMAN_2: (ItemChannel.ILLIDAN_KAEL, ItemChannel.NONE),
...
MISSION_TO_ITEM_SLOT: dict[Wc3Mission, tuple[ItemChannel, ItemChannel]] = {
    ...
    Wc3Mission.NX8_THE_BROTHERS_STORMRAGE: (ItemChannel.TFT_NIGHT_ELF, ItemChannel.ILLIDAN_KAEL),
    Wc3Mission.HX5_GATES_OF_THE_ABYSS: (ItemChannel.ILLIDAN_KAEL, ItemChannel.ILLIDAN_KAEL),
    Wc3Mission.HX6_LORD_OF_OUTLAND: (ItemChannel.ILLIDAN_KAEL, ItemChannel.ILLIDAN_KAEL),
...
ITEM_CHANNEL_TO_DEFAULT_HERO: dict[ItemChannel, HeroSlot] = {
    ...
    ItemChannel.ILLIDAN_KAEL: HeroSlot.KAEL,
...
MISSION_TO_PRESET_MERCENARIES: dict[Wc3Mission, dict[int, Wc3Item]] = {
    Wc3Mission.H2_BLACKROCK_AND_ROLL: {
        ...
        2: Wc3Item.MERC_MURLOC_HUNTSMAN,
        3: Wc3Item.MERC_GNOLL_BRUTE,
    },
    Wc3Mission.H4_THE_CULT_OF_THE_DAMNED: {
        0: Wc3Item.MERC_FOREST_TROLL_SHADOW_PRIEST,
        1: Wc3Item.MERC_MURLOC_NIGHTCRAWLER,
    ...
    Wc3Mission.H5_MARCH_OF_THE_SCOURGE: {
        ...
        3: Wc3Item.MERC_OGRE_MAGI,
    },
    Wc3Mission.H6_THE_CULLING: {
        0: Wc3Item.MERC_ENFORCER,
        1: Wc3Item.MERC_ASSASSIN,
        2: Wc3Item.MERC_ROGUE_WIZARD,
        3: Wc3Item.MERC_ROCK_GOLEM,
    },
    Wc3Mission.H7_THE_SHORES_OF_NORTHREND: {
        0: Wc3Item.MERC_ICE_TROLL_BERSERKER,
        1: Wc3Item.MERC_NERUBIAN_WEBSPINNER,
        2: Wc3Item.MERC_WENDIGO_SHAMAN,
