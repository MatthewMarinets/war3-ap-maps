...
class Wc3Item(enum.Enum):
    ...
    """Vanilla: Hu2, Hu5, Hu7"""
    """Vanilla: Hu5, Hu9"""
    H_RING_OF_PROTECTION_1 =         2100, "Ring of Protection +1 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_1, Wc3Race.HUMAN)
    H_TOME_OF_STRENGTH =             2101, "Tome of Strength (Human)",              PickupItem(1, GameID.TOME_OF_STRENGTH, Wc3Race.HUMAN)
    H_CLAWS_OF_ATTACK_3 =            2102, "Claws of Attack +3 (Human)",            PickupItem(1, GameID.CLAWS_OF_ATTACK_3, Wc3Race.HUMAN)
    H_GAUNTLETS_OF_OGRE_STRENGTH_3 = 2103, "Gauntlets of Ogre Strength +3 (Human)", PickupItem(3, GameID.GAUNTLETS_OF_OGRE_STRENGTH_3, Wc3Race.HUMAN)
    H_BRACER_OF_AGILITY =            2104, "Bracer of Agility +1 (Human)",          PickupItem(1, GameID.BRACER_OF_AGILITY, Wc3Race.HUMAN)
    H_MAUL_OF_STRENGTH =             2105, "Maul of Strength +1 (Human)",           PickupItem(1, GameID.MAUL_OF_STRENGTH, Wc3Race.HUMAN)
    H_MANTLE_OF_INTELLIGENCE_3 =     2106, "Mantle of Intelligence +3 (Human)",     PickupItem(1, GameID.MANTLE_OF_INTELLIGENCE_3, Wc3Race.HUMAN)
    H_RING_OF_PROTECTION_2 =         2107, "Ring of Protection +2 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_2, Wc3Race.HUMAN)
    H_CLAWS_OF_ATTACK_6 =            2108, "Claws of Attack +6 (Human)",            PickupItem(1, GameID.CLAWS_OF_ATTACK_6, Wc3Race.HUMAN)
    H_RING_OF_SUPERIORITY =          2109, "Ring of Superiority (Human)",           PickupItem(1, GameID.RING_OF_SUPERIORITY, Wc3Race.HUMAN)
    H_PERIAPT_OF_VITALITY =          2110, "Periapt of Vitality (Human)",           PickupItem(2, GameID.PERIAPT_OF_VITALITY, Wc3Race.HUMAN)
    H_MEDALLION_OF_COURAGE =         2111, "Medallion of Courage (Human)",          PickupItem(1, GameID.MEDALLION_OF_COURAGE, Wc3Race.HUMAN)
    H_BOOTS_OF_SPEED =               2112, "Boots of Speed (Human)",                PickupItem(1, GameID.BOOTS_OF_SPEED, Wc3Race.HUMAN)
    H_TOME_OF_STRENGTH_2 =           2113, "Tome of Strength +2 (Human)",           PickupItem(1, GameID.TOME_OF_STRENGTH_2, Wc3Race.HUMAN)
    H_TALISMAN_OF_EVASION =          2114, "Talisman of Evasion (Human)",           PickupItem(1, GameID.TALISMAN_OF_EVASION, Wc3Race.HUMAN)
    H_ORB_OF_FROST =                 2115, "Orb of Frost (Human)",                  PickupItem(1, GameID.ORB_OF_FROST, Wc3Race.HUMAN)
    H_MANUAL_OF_HEALTH =             2116, "Manual of Health (Human)",              PickupItem(1, GameID.MANUAL_OF_HEALTH, Wc3Race.HUMAN)
    H_GOBLIN_NIGHT_SCOPE =           2117, "Goblin Night Scope (Human)",            PickupItem(1, GameID.GOBLIN_NIGHT_SCOPE, Wc3Race.HUMAN)
    H_CLAWS_OF_ATTACK_12 =           2118, "Claws of Attack +12 (Human)",           PickupItem(1, GameID.CLAWS_OF_ATTACK_12, Wc3Race.HUMAN)
    H_SOBI_MASK =                    2119, "Sobi Mask (Human)",                     PickupItem(1, GameID.SOBI_MASK, Wc3Race.HUMAN)
    H_PENDANT_OF_MANA =              2120, "Pendant of Mana (Human)",               PickupItem(1, GameID.PENDANT_OF_MANA, Wc3Race.HUMAN)
