...
class Wc3Item(enum.Enum):
    ...
    """Vanilla: Hu2, Hu5, Hu7"""
    """Vanilla: Hu5, Hu9"""
    H_RING_OF_PROTECTION_1 =         2100, "Ring of Protection +1 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_1, Wc3Campaign.HUMAN_1)
    H_TOME_OF_STRENGTH =             2101, "Tome of Strength (Human)",              PickupItem(1, GameID.TOME_OF_STRENGTH, Wc3Campaign.HUMAN_1)
    H_CLAWS_OF_ATTACK_3 =            2102, "Claws of Attack +3 (Human)",            PickupItem(1, GameID.CLAWS_OF_ATTACK_3, Wc3Campaign.HUMAN_1)
    H_GAUNTLETS_OF_OGRE_STRENGTH_3 = 2103, "Gauntlets of Ogre Strength +3 (Human)", PickupItem(3, GameID.GAUNTLETS_OF_OGRE_STRENGTH_3, Wc3Campaign.HUMAN_1)
    H_BRACER_OF_AGILITY =            2104, "Bracer of Agility +1 (Human)",          PickupItem(1, GameID.BRACER_OF_AGILITY, Wc3Campaign.HUMAN_1)
    H_MAUL_OF_STRENGTH =             2105, "Maul of Strength +1 (Human)",           PickupItem(1, GameID.MAUL_OF_STRENGTH, Wc3Campaign.HUMAN_1)
    H_MANTLE_OF_INTELLIGENCE_3 =     2106, "Mantle of Intelligence +3 (Human)",     PickupItem(1, GameID.MANTLE_OF_INTELLIGENCE_3, Wc3Campaign.HUMAN_1)
    H_RING_OF_PROTECTION_2 =         2107, "Ring of Protection +2 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_2, Wc3Campaign.HUMAN_1)
    H_CLAWS_OF_ATTACK_6 =            2108, "Claws of Attack +6 (Human)",            PickupItem(1, GameID.CLAWS_OF_ATTACK_6, Wc3Campaign.HUMAN_1)
    H_RING_OF_SUPERIORITY =          2109, "Ring of Superiority (Human)",           PickupItem(1, GameID.RING_OF_SUPERIORITY, Wc3Campaign.HUMAN_1)
    H_PERIAPT_OF_VITALITY =          2110, "Periapt of Vitality (Human)",           PickupItem(2, GameID.PERIAPT_OF_VITALITY, Wc3Campaign.HUMAN_1)
    H_MEDALLION_OF_COURAGE =         2111, "Medallion of Courage (Human)",          PickupItem(1, GameID.MEDALLION_OF_COURAGE, Wc3Campaign.HUMAN_1)
    H_BOOTS_OF_SPEED =               2112, "Boots of Speed (Human)",                PickupItem(1, GameID.BOOTS_OF_SPEED, Wc3Campaign.HUMAN_1)
    H_TOME_OF_STRENGTH_2 =           2113, "Tome of Strength +2 (Human)",           PickupItem(1, GameID.TOME_OF_STRENGTH_2, Wc3Campaign.HUMAN_1)
    H_TALISMAN_OF_EVASION =          2114, "Talisman of Evasion (Human)",           PickupItem(1, GameID.TALISMAN_OF_EVASION, Wc3Campaign.HUMAN_1)
    H_ORB_OF_FROST =                 2115, "Orb of Frost (Human)",                  PickupItem(1, GameID.ORB_OF_FROST, Wc3Campaign.HUMAN_1)
    H_MANUAL_OF_HEALTH =             2116, "Manual of Health (Human)",              PickupItem(1, GameID.MANUAL_OF_HEALTH, Wc3Campaign.HUMAN_1)
    H_GOBLIN_NIGHT_SCOPE =           2117, "Goblin Night Scope (Human)",            PickupItem(1, GameID.GOBLIN_NIGHT_SCOPE, Wc3Campaign.HUMAN_1)
    H_CLAWS_OF_ATTACK_12 =           2118, "Claws of Attack +12 (Human)",           PickupItem(1, GameID.CLAWS_OF_ATTACK_12, Wc3Campaign.HUMAN_1)
    H_SOBI_MASK =                    2119, "Sobi Mask (Human)",                     PickupItem(1, GameID.SOBI_MASK, Wc3Campaign.HUMAN_1)
    H_PENDANT_OF_MANA =              2120, "Pendant of Mana (Human)",               PickupItem(1, GameID.PENDANT_OF_MANA, Wc3Campaign.HUMAN_1)
    H_RING_OF_REGENERATION =         2121, "Ring of Regeneration (Human)",          PickupItem(1, GameID.RING_OF_REGENERATION, Wc3Campaign.HUMAN_1)
    H_RING_OF_PROTECTION_3 =         2122, "Ring of Protection +3 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_3, Wc3Campaign.HUMAN_1)
    H_TOME_OF_AGILITY =              2123, "Tome of Agility (Human)",               PickupItem(1, GameID.TOME_OF_AGILITY, Wc3Campaign.HUMAN_1)
    H_POTION_OF_HEALING =            2124, "Potion of Healing (Human)",             PickupItem(1, GameID.POTION_OF_HEALING, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_MANA =               2125, "Potion of Mana (Human)",                PickupItem(1, GameID.POTION_OF_MANA, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_HEALING =            2126, "Scroll of Healing (Human)",             PickupItem(1, GameID.SCROLL_OF_HEALING, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_PROTECTION =         2127, "Scroll of Protection (Human)",          PickupItem(1, GameID.SCROLL_OF_PROTECTION, Wc3Campaign.HUMAN_1, charged=True)
    H_WAND_OF_NEGATION =             2128, "Wand of Negation (Human)",              PickupItem(1, GameID.WAND_OF_NEGATION, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_GREATER_HEALING =    2129, "Potion of Greater Healing (Human)",     PickupItem(1, GameID.POTION_OF_GREATER_HEALING, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_RESTORATION =        2130, "Potion of Restoration (Human)",         PickupItem(1, GameID.POTION_OF_RESTORATION, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_TOWN_PORTAL =        2131, "Scroll of Town Portal (Human)",         PickupItem(2, GameID.SCROLL_OF_TOWN_PORTAL, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_THE_BEAST =          2132, "Scroll of the Beast (Human)",           PickupItem(1, GameID.SCROLL_OF_THE_BEAST, Wc3Campaign.HUMAN_1, charged=True)
    H_MANA_STONE =                   2133, "Mana Stone (Human)",                    PickupItem(1, GameID.MANA_STONE, Wc3Campaign.HUMAN_1, charged=True)
    H_HEALTH_STONE =                 2134, "Health Stone (Human)",                  PickupItem(1, GameID.HEALTH_STONE, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_GREATER_MANA =       2135, "Potion of Greater Mana (Human)",        PickupItem(1, GameID.POTION_OF_GREATER_MANA, Wc3Campaign.HUMAN_1, charged=True)
    H_HEALING_WARDS =                2136, "Healing Wards (Human)",                 PickupItem(1, GameID.HEALING_WARDS, Wc3Campaign.HUMAN_1, charged=True)

    U_RING_OF_PROTECTION_2 =         2200, "Ring of Protection +2 (Undead)",        PickupItem(1, GameID.RING_OF_PROTECTION_2, Wc3Campaign.UNDEAD_1)
    U_SPIDER_RING =                  2201, "Spider Ring (Undead)",                  PickupItem(1, GameID.SPIDER_RING, Wc3Campaign.UNDEAD_1)
    U_GAUNTLETS_OF_OGRE_STRENGTH_3 = 2202, "Gauntlets of Ogre Strength +3 (Undead)",PickupItem(1, GameID.GAUNTLETS_OF_OGRE_STRENGTH_3, Wc3Campaign.UNDEAD_1)
