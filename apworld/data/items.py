...
class Wc3Item(enum.Enum):
    ...
    H_BOOTS_OF_SPEED =               2100, "Boots of Speed (Human)",                PickupItem(1, GameID.BOOTS_OF_SPEED, Wc3Campaign.HUMAN_1)
    H_BRACER_OF_AGILITY =            2101, "Bracer of Agility +1 (Human)",          PickupItem(1, GameID.BRACER_OF_AGILITY, Wc3Campaign.HUMAN_1)
    H_CLAWS_OF_ATTACK_3 =            2102, "Claws of Attack +3 (Human)",            PickupItem(1, GameID.CLAWS_OF_ATTACK_3, Wc3Campaign.HUMAN_1)
    H_CLAWS_OF_ATTACK_6 =            2103, "Claws of Attack +6 (Human)",            PickupItem(1, GameID.CLAWS_OF_ATTACK_6, Wc3Campaign.HUMAN_1)
    H_CLAWS_OF_ATTACK_12 =           2104, "Claws of Attack +12 (Human)",           PickupItem(1, GameID.CLAWS_OF_ATTACK_12, Wc3Campaign.HUMAN_1)
    H_GAUNTLETS_OF_OGRE_STRENGTH_3 = 2105, "Gauntlets of Ogre Strength +3 (Human)", PickupItem(3, GameID.GAUNTLETS_OF_OGRE_STRENGTH_3, Wc3Campaign.HUMAN_1)
    H_GOBLIN_NIGHT_SCOPE =           2106, "Goblin Night Scope (Human)",            PickupItem(1, GameID.GOBLIN_NIGHT_SCOPE, Wc3Campaign.HUMAN_1)
    H_MANTLE_OF_INTELLIGENCE_3 =     2107, "Mantle of Intelligence +3 (Human)",     PickupItem(1, GameID.MANTLE_OF_INTELLIGENCE_3, Wc3Campaign.HUMAN_1)
    H_MAUL_OF_STRENGTH =             2108, "Maul of Strength +1 (Human)",           PickupItem(1, GameID.MAUL_OF_STRENGTH, Wc3Campaign.HUMAN_1)
    H_MEDALLION_OF_COURAGE =         2109, "Medallion of Courage (Human)",          PickupItem(1, GameID.MEDALLION_OF_COURAGE, Wc3Campaign.HUMAN_1)
    H_ORB_OF_FROST =                 2110, "Orb of Frost (Human)",                  PickupItem(1, GameID.ORB_OF_FROST, Wc3Campaign.HUMAN_1)
    H_ORB_OF_FIRE =                  2111, "Orb of Fire (Human)",                   PickupItem(1, GameID.ORB_OF_FIRE, Wc3Campaign.HUMAN_1)
    H_PENDANT_OF_MANA =              2112, "Pendant of Mana (Human)",               PickupItem(1, GameID.PENDANT_OF_MANA, Wc3Campaign.HUMAN_1)
    H_PERIAPT_OF_VITALITY =          2113, "Periapt of Vitality (Human)",           PickupItem(2, GameID.PERIAPT_OF_VITALITY, Wc3Campaign.HUMAN_1)
    H_RING_OF_PROTECTION_1 =         2114, "Ring of Protection +1 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_1, Wc3Campaign.HUMAN_1)
    H_RING_OF_PROTECTION_2 =         2115, "Ring of Protection +2 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_2, Wc3Campaign.HUMAN_1)
    H_RING_OF_PROTECTION_3 =         2116, "Ring of Protection +3 (Human)",         PickupItem(1, GameID.RING_OF_PROTECTION_3, Wc3Campaign.HUMAN_1)
    H_RING_OF_REGENERATION =         2117, "Ring of Regeneration (Human)",          PickupItem(1, GameID.RING_OF_REGENERATION, Wc3Campaign.HUMAN_1)
    H_RING_OF_SUPERIORITY =          2118, "Ring of Superiority (Human)",           PickupItem(1, GameID.RING_OF_SUPERIORITY, Wc3Campaign.HUMAN_1)
    H_SOBI_MASK =                    2119, "Sobi Mask (Human)",                     PickupItem(1, GameID.SOBI_MASK, Wc3Campaign.HUMAN_1)
    H_TALISMAN_OF_EVASION =          2120, "Talisman of Evasion (Human)",           PickupItem(1, GameID.TALISMAN_OF_EVASION, Wc3Campaign.HUMAN_1)

    H_HEALING_WARDS =                2150, "Healing Wards (Human)",                         PickupItem(1, GameID.HEALING_WARDS, Wc3Campaign.HUMAN_1, charged=True)
    H_HEALTH_STONE =                 2151, "Health Stone (Human)",                          PickupItem(1, GameID.HEALTH_STONE, Wc3Campaign.HUMAN_1, charged=True)
    H_MANA_STONE =                   2152, "Mana Stone (Human)",                            PickupItem(1, GameID.MANA_STONE, Wc3Campaign.HUMAN_1, charged=True)
    H_MANUAL_OF_HEALTH =             2153, "Manual of Health (Human)",                      PickupItem(1, GameID.MANUAL_OF_HEALTH, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_GREATER_HEALING =    2154, "Potion of Greater Healing (Human)",             PickupItem(4, GameID.POTION_OF_GREATER_HEALING, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_GREATER_MANA =       2155, "Potion of Greater Mana (Human)",                PickupItem(2, GameID.POTION_OF_GREATER_MANA, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_HEALING =            2156, "Potion of Healing (Human)",                     PickupItem(7, GameID.POTION_OF_HEALING, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_MANA =               2157, "Potion of Mana (Human)",                        PickupItem(10, GameID.POTION_OF_MANA, Wc3Campaign.HUMAN_1, charged=True)
    H_POTION_OF_RESTORATION =        2158, "Potion of Restoration (Human)",                 PickupItem(1, GameID.POTION_OF_RESTORATION, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_HEALING =            2159, "Scroll of Healing (Human)",                     PickupItem(3, GameID.SCROLL_OF_HEALING, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_PROTECTION =         2160, "Scroll of Protection (Human)",                  PickupItem(4, GameID.SCROLL_OF_PROTECTION, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_TOWN_PORTAL =        2161, "Scroll of Town Portal (Human)",                 PickupItem(2, GameID.SCROLL_OF_TOWN_PORTAL, Wc3Campaign.HUMAN_1, charged=True)
    H_SCROLL_OF_THE_BEAST =          2162, "Scroll of the Beast (Human)",                   PickupItem(1, GameID.SCROLL_OF_THE_BEAST, Wc3Campaign.HUMAN_1, charged=True)
    H_TOME_OF_AGILITY =              2163, "Tome of Agility (Human)",                       PickupItem(1, GameID.TOME_OF_AGILITY, Wc3Campaign.HUMAN_1, charged=True)
    H_TOME_OF_STRENGTH =             2164, "Tome of Strength (Human)",                      PickupItem(1, GameID.TOME_OF_STRENGTH, Wc3Campaign.HUMAN_1, charged=True)
    H_TOME_OF_STRENGTH_2 =           2165, "Tome of Strength +2 (Human)",                   PickupItem(1, GameID.TOME_OF_STRENGTH_2, Wc3Campaign.HUMAN_1, charged=True)
    H_WAND_OF_NEGATION =             2166, "Wand of Negation (Human)",                      PickupItem(1, GameID.WAND_OF_NEGATION, Wc3Campaign.HUMAN_1, charged=True)

    # Undead Campaign Items
    U_ANTI_MAGIC_POTION =            2200, "Anti-Magic Potion (Undead)",                     PickupItem(1, GameID.ANTI_MAGIC_POTION, Wc3Campaign.UNDEAD_1)
    U_BOOTS_OF_QUELTHALAS_6 =        2201, "Boots of Quel'Thalas +6 (Undead)",               PickupItem(1, GameID.BOOTS_OF_QUELTHALAS_6, Wc3Campaign.UNDEAD_1)
    U_CLAWS_OF_ATTACK_6 =            2202, "Claws of Attack +6 (Undead)",                    PickupItem(1, GameID.CLAWS_OF_ATTACK_6, Wc3Campaign.UNDEAD_1)
    U_CLAWS_OF_ATTACK_9 =            2203, "Claws of Attack +9 (Undead)",                    PickupItem(1, GameID.CLAWS_OF_ATTACK_9, Wc3Campaign.UNDEAD_1)
    U_GAUNTLETS_OF_OGRE_STRENGTH_3 = 2204, "Gauntlets of Ogre Strength +3 (Undead)",         PickupItem(1, GameID.GAUNTLETS_OF_OGRE_STRENGTH_3, Wc3Campaign.UNDEAD_1)
    U_GLOVES_OF_HASTE =              2205, "Gloves of Haste (Undead)",                       PickupItem(1, GameID.GLOVES_OF_HASTE, Wc3Campaign.UNDEAD_1)
    U_GOBLIN_NIGHT_SCOPE =           2206, "Goblin Night Scope (Undead)",                    PickupItem(1, GameID.GOBLIN_NIGHT_SCOPE, Wc3Campaign.UNDEAD_1)
    U_HOOD_OF_CUNNING =              2207, "Hood of Cunning (Undead)",                       PickupItem(1, GameID.HOOD_OF_CUNNING, Wc3Campaign.UNDEAD_1)
    U_KHADGARS_PIPE_OF_INSIGHT =     2208, "Khadgar's Pipe of Insight (Undead)",             PickupItem(1, GameID.KHADGARS_PIPE_OF_INSIGHT, Wc3Campaign.UNDEAD_1)
    U_MANTLE_OF_INTELLIGENCE_3 =     2209, "Mantle of Intelligence +3 (Undead)",             PickupItem(1, GameID.MANTLE_OF_INTELLIGENCE_3, Wc3Campaign.UNDEAD_1)
    U_MEDALLION_OF_COURAGE =         2210, "Medallion of Courage (Undead)",                  PickupItem(1, GameID.MEDALLION_OF_COURAGE, Wc3Campaign.UNDEAD_1)
    U_PENDANT_OF_ENERGY =            2211, "Pendant of Energy (Undead)",                     PickupItem(1, GameID.PENDANT_OF_ENERGY, Wc3Campaign.UNDEAD_1)
    U_PENDANT_OF_MANA =              2212, "Pendant of Mana (Undead)",                       PickupItem(1, GameID.PENDANT_OF_MANA, Wc3Campaign.UNDEAD_1)
    U_PERIAPT_OF_VITALITY =          2213, "Periapt of Vitality (Undead)",                   PickupItem(1, GameID.PERIAPT_OF_VITALITY, Wc3Campaign.UNDEAD_1)
    U_RING_OF_PROTECTION_2 =         2214, "Ring of Protection +2 (Undead)",                 PickupItem(2, GameID.RING_OF_PROTECTION_2, Wc3Campaign.UNDEAD_1)
    U_RING_OF_PROTECTION_3 =         2215, "Ring of Protection +3 (Undead)",                 PickupItem(1, GameID.RING_OF_PROTECTION_3, Wc3Campaign.UNDEAD_1)
    U_RING_OF_PROTECTION_5 =         2216, "Ring of Protection +5 (Undead)",                 PickupItem(1, GameID.RING_OF_PROTECTION_5, Wc3Campaign.UNDEAD_1)
    U_RING_OF_REGENERATION =         2217, "Ring of Regeneration (Undead)",                  PickupItem(1, GameID.RING_OF_REGENERATION, Wc3Campaign.UNDEAD_1)
    U_SLIPPERS_OF_AGILITY_3 =        2218, "Slippers of Agility +3 (Undead)",                PickupItem(1, GameID.SLIPPERS_OF_AGILITY_3, Wc3Campaign.UNDEAD_1)
    U_SOBI_MASK =                    2219, "Sobi Mask (Undead)",                             PickupItem(1, GameID.SOBI_MASK, Wc3Campaign.UNDEAD_1)
    U_SPIDER_RING =                  2220, "Spider Ring (Undead)",                           PickupItem(1, GameID.SPIDER_RING, Wc3Campaign.UNDEAD_1)
    U_VOODOO_DOLL =                  2221, "Voodoo Doll (Undead)",                           PickupItem(1, GameID.VOODOO_DOLL, Wc3Campaign.UNDEAD_1)

    U_BOOK_OF_THE_DEAD =             2250, "Book of the Dead (Undead)",                      PickupItem(1, GameID.BOOK_OF_THE_DEAD, Wc3Campaign.UNDEAD_1, charged=True)
    U_GOBLIN_LAND_MINES =            2251, "Goblin Land Mines (Undead)",                     PickupItem(1, GameID.GOBLIN_LAND_MINES, Wc3Campaign.UNDEAD_1, charged=True)
    U_HEALTH_STONE =                 2252, "Health Stone (Undead)",                          PickupItem(2, GameID.HEALTH_STONE, Wc3Campaign.UNDEAD_1, charged=True)
    U_MANA_STONE =                   2253, "Mana Stone (Undead)",                            PickupItem(1, GameID.MANA_STONE, Wc3Campaign.UNDEAD_1, charged=True)
    U_MANUAL_OF_HEALTH =             2254, "Manual of Health (Undead)",                      PickupItem(1, GameID.MANUAL_OF_HEALTH, Wc3Campaign.UNDEAD_1, charged=True)
    U_POTION_OF_GREATER_HEALING =    2255, "Potion of Greater Healing (Undead)",             PickupItem(6, GameID.POTION_OF_GREATER_HEALING, Wc3Campaign.UNDEAD_1, charged=True)
    U_POTION_OF_GREATER_MANA =       2256, "Potion of Greater Mana (Undead)",                PickupItem(3, GameID.POTION_OF_GREATER_MANA, Wc3Campaign.UNDEAD_1, charged=True)
    U_POTION_OF_HEALING =            2257, "Potion of Healing (Undead)",                     PickupItem(6, GameID.POTION_OF_HEALING, Wc3Campaign.UNDEAD_1, charged=True)
    U_POTION_OF_MANA =               2258, "Potion of Mana (Undead)",                        PickupItem(1, GameID.POTION_OF_MANA, Wc3Campaign.UNDEAD_1, charged=True)
    U_SCEPTER_OF_MASTERY =           2259, "Scepter of Mastery (Undead)",                    PickupItem(1, GameID.SCEPTER_OF_MASTERY, Wc3Campaign.UNDEAD_1, charged=True)
    U_SCROLL_OF_HEALING =            2260, "Scroll of Healing (Undead)",                     PickupItem(3, GameID.SCROLL_OF_HEALING, Wc3Campaign.UNDEAD_1, charged=True)
    U_SCROLL_OF_MANA =               2261, "Scroll of Mana (Undead)",                        PickupItem(3, GameID.SCROLL_OF_MANA, Wc3Campaign.UNDEAD_1, charged=True)
    U_SCROLL_OF_PROTECTION =         2262, "Scroll of Protection (Undead)",                  PickupItem(1, GameID.SCROLL_OF_PROTECTION, Wc3Campaign.UNDEAD_1, charged=True)
    U_SCROLL_OF_THE_BEAST =          2263, "Scroll of the Beast (Undead)",                   PickupItem(2, GameID.SCROLL_OF_THE_BEAST, Wc3Campaign.UNDEAD_1, charged=True)
    U_TOME_OF_AGILITY =              2264, "Tome of Agility (Undead)",                       PickupItem(1, GameID.TOME_OF_AGILITY, Wc3Campaign.UNDEAD_1, charged=True)
    U_TOME_OF_INTELLIGENCE =         2265, "Tome of Intelligence (Undead)",                  PickupItem(3, GameID.TOME_OF_INTELLIGENCE, Wc3Campaign.UNDEAD_1, charged=True)
    U_TOME_OF_KNOWLEDGE =            2266, "Tome of Knowledge (Undead)",                     PickupItem(1, GameID.TOME_OF_KNOWLEDGE, Wc3Campaign.UNDEAD_1, charged=True)
    U_TOME_OF_STRENGTH =             2267, "Tome of Strength (Undead)",                      PickupItem(1, GameID.TOME_OF_STRENGTH, Wc3Campaign.UNDEAD_1, charged=True)
    U_TOME_OF_STRENGTH_2 =           2268, "Tome of Strength +2 (Undead)",                   PickupItem(1, GameID.TOME_OF_STRENGTH_2, Wc3Campaign.UNDEAD_1, charged=True)

    N_HORN_OF_CENARIUS =             2400, "Horn of Cenarius (Night Elf)",          PickupItem(1, GameID.HORN_OF_CENARIUS, Wc3Campaign.NIGHT_ELF_1)
