...
MODIFICATION_TYPES: dict[LiteralString, DataType] = {
    ...
    eid.FIELD_ABIL_TOOLTIP_TURN_OFF: DataType.String,
    eid.FIELD_ABIL_TOOLTIP_TURN_OFF_EXTENDED: DataType.String,
    eid.FIELD_ABIL_TOOLTIP_LEARN: DataType.String,
    eid.FIELD_ABIL_TOOLTIP_LEARN_EXTENDED: DataType.String,
    ...
    eid.FIELD_ABIL_ART_MISSILE: DataType.String,
    eid.FIELD_ABIL_ART_TARGET: DataType.String,
    eid.FIELD_ABIL_NUM_TARGET_ATTACHMENTS: DataType.Integer,
    eid.FIELD_ABIL_ATTACHMENT_POINT_0: DataType.String,
    eid.FIELD_ABIL_ATTACHMENT_POINT_1: DataType.String,
    eid.FIELD_ABIL_ATTACHMENT_POINT_2: DataType.String,
    eid.FIELD_ABIL_ATTACHMENT_POINT_3: DataType.String,
    eid.FIELD_ABIL_ATTACHMENT_POINT_4: DataType.String,
    eid.FIELD_ABIL_ATTACHMENT_POINT_5: DataType.String,
    ...
    eid.FIELD_ABIL_DATA_CHAOS_NEW_UNIT_TYPE: DataType.String,
    ...
    # Buffs
    eid.FIELD_BUFF_TOOLTIP_EXTENDED: DataType.String,

    # Items
    eid.FIELD_ITEM_NAME: DataType.String,
    eid.FIELD_ITEM_TOOLTIP_BASIC: DataType.String,
    eid.FIELD_ITEM_TOOLTIP_EXTENDED: DataType.String,
    eid.FIELD_ITEM_DESCRIPTION: DataType.String,
    eid.FIELD_ITEM_ABILITIES: DataType.String,
    eid.FIELD_ITEM_ARMOR_TYPE: DataType.String,
    eid.FIELD_ITEM_CAN_BE_DROPPED: DataType.Integer,
    eid.FIELD_ITEM_COOLDOWN_GROUP: DataType.String,
    eid.FIELD_ITEM_DROPPED_WHEN_CARRIER_DIES: DataType.Integer,
    eid.FIELD_ITEM_GOLD_COST: DataType.Integer,
    eid.FIELD_ITEM_HIT_POINTS: DataType.Integer,
    eid.FIELD_ITEM_IGNORE_COOLDOWN: DataType.Integer,
    eid.FIELD_ITEM_INTERFACE_ICON: DataType.String,
    eid.FIELD_ITEM_LEVEL: DataType.Integer,
    eid.FIELD_ITEM_LUMBER_COST: DataType.Integer,
    eid.FIELD_ITEM_MODEL_USED: DataType.String,
    eid.FIELD_ITEM_TINT_BLUE: DataType.Integer,
    eid.FIELD_ITEM_TINT_GREEN: DataType.Integer,
    eid.FIELD_ITEM_TINT_RED: DataType.Integer,
    ...
    eid.FIELD_UNIT_ATTACK_1_COOLDOWN_TIME: DataType.Unreal,
    eid.FIELD_UNIT_ATTACK_1_DAMAGE_BASE: DataType.Integer,
    eid.FIELD_UNIT_ATTACK_1_DAMAGE_NUM_DICE: DataType.Integer,
    eid.FIELD_UNIT_ATTACK_1_DAMAGE_SIDES_PER_DIE: DataType.Integer,
    ...
    eid.FIELD_UNIT_ATTACK_2_ATTACK_TYPE: DataType.String,
    eid.FIELD_UNIT_ATTACK_2_COOLDOWN_TIME: DataType.Unreal,
    eid.FIELD_UNIT_ATTACK_2_DAMAGE_BASE: DataType.Integer,
    eid.FIELD_UNIT_ATTACK_2_DAMAGE_NUM_DICE: DataType.Integer,
    eid.FIELD_UNIT_ATTACK_2_DAMAGE_SIDES_PER_DIE: DataType.Integer,
    eid.FIELD_UNIT_ATTACK_2_RANGE: DataType.Integer,
    eid.FIELD_UNIT_ATTACK_2_WEAPON_TYPE: DataType.String,
    eid.FIELD_UNIT_BALANCE_BUILD_TIME: DataType.Integer,
    eid.FIELD_UNIT_BALANCE_DEFENSE_BASE: DataType.Integer,
    eid.FIELD_UNIT_BALANCE_SPEED_BASE: DataType.Integer,
    eid.FIELD_UNIT_BALANCE_STARTING_AGILITY: DataType.Integer,
    eid.FIELD_UNIT_BALANCE_STARTING_INTELLIGENCE: DataType.Integer,
    eid.FIELD_UNIT_BALANCE_STARTING_STRENGTH: DataType.Integer,
    eid.FIELD_UNIT_BALANCE_AGILITY_PER_LEVEL: DataType.Unreal,
    eid.FIELD_UNIT_BALANCE_INTELLIGENCE_PER_LEVEL: DataType.Unreal,
    eid.FIELD_UNIT_BALANCE_STRENGTH_PER_LEVEL: DataType.Unreal,
